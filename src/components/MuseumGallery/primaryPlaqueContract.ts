...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'ibn-tufayl': 'Enter Ibn Tufayl’s island test. Ask how body, proof, contemplation, scripture, and speech yield distinct knowledge—and why Hayy’s failed mission tests whether lone insight can teach others well in shared public life.',
  ...
  'mary-astell': 'Follow Astell from soul to school and home. Ask how barred learning breeds dependence, why unchecked marital power is wrong, and where her church, crown, and rank commitments still limit her challenge.',
  ...
  'ancient-greek': 'Trace debates from scattered evidence, civic argument, schools, and later reception. Ask how inquiry into nature, knowledge, virtue, and politics emerged across Mediterranean worlds—without treating this contested history as philosophy’s universal beginning.',
  epicureanism: 'Enter the Garden by a charred roll. Ask how atoms, death, desire, friends, calm, and wise choice ease fear—without calling this roll Epicurus’s text or taking pleasure as wealth, excess, or retreat.',
  cynicism: 'See later art pit Diogenes against Alexander. Ask how need, frank speech, hard training, and world ties test custom—without taking old tales as fact, this image as proof, or revolt as a full creed.',
  skepticism: 'Open a 1569 page of Sextus. Compare Academic tests with Pyrrhonian suspension, then ask how doubt guides life—without making a late print ancient, two paths one creed, or inquiry mere denial alone.',
  'chinese-philosophy': 'Use a bronze from Warring States China. Ask how rites, names, law, and rule faced debate—without making one vessel speak for a school, one age define all thought, or sharp rifts fade into calm.',
  logic: 'Study Hamilton’s Euler diagrams. Ask how validity, truth, proof, and systems guide reasoning—without making one 1874 page logic’s origin, proof of true premises, or a universal map for all forms of thought.',
  'philosophy-of-language': 'Meet the Rosetta Stone as a material problem of translation. Ask how signs, reference, use, interpretation, and power make meaning contested—without treating one decree, one language, or one modern theory as language’s origin.',
  aesthetics: 'Look with Hokusai’s wave at form, danger, labor, distance, and reproduction. Ask how beauty, art, expression, and judgment invite reasons—without making one celebrated Japanese print a single universal definition of aesthetic value.',
  pragmatism: 'Use Peirce’s map to enter inquiry. Ask how acts test ideas, facts revise belief, and shared trials aid democracy—while asking whose pain and voice count when a group calls its own test fair.',
  'analytic-philosophy': 'Meet four analytic founders, then question a tidy collage. Follow changing uses of logic, language, science, analysis, and argument—while asking whose work one canon omits and why no portrait set defines a field.',
  existentialism: 'Enter Munch’s early crowd. Ask how freedom meets body, past, force, doubt, duty, and revolt—without making one scene a creed, blaming people for set limits, or turning life into lone choice or despair.',
  phenomenology: 'Study Cézanne’s earlier table scene as an invitation to describe appearance. Ask how objects, bodies, time, and shared worlds gain meaning—without treating one painting as proof or attentive description as theory-free sight.',
  'continental-philosophy': 'Use a map to test a label, not find a creed. Trace work on time, bodies, words, power, and critique—then ask how academic lines omit, divide, and blur the thought they sort.',
  deontology: 'Look at an oath’s drama of role and sacrifice without mistaking it for Kant’s theory. Ask what duties, rights, respect, and reasons constrain action when promising outcomes tempt us to use one person for another.',
  utilitarianism: 'Meet Sidgwick as one systematizer, not the whole tradition. Ask how impartial concern for welfare guides action and institutions while choices about value, uncertainty, distribution, rights, demandingness, and future people remain contested.',
  confucianism: 'Enter Confucianism through an Edo-period reception panel. Ask how learning, ritual, humaneness, and relationships shape persons and political authority—testing when inherited roles cultivate care, when they conceal hierarchy, and how lineages remade Confucianism.',
  daoism: 'Enter Daoism through a Ming landscape. Follow dao, non-forcing, changing perspectives, skill, practice, and ritual histories—while asking how composite texts, attributed personas, and diverse communities resist one founder, one technique, or a single creed.',
  mohism: 'Meet Mohism beside a Warring States crossbow trigger. Ask how inclusive concern, public standards, benefit, argument, and defense challenged aggression—without calling a layered corpus Mozi’s single book, its Canons modern science, or simply utilitarianism.',
  legalism: 'See Legalism through a Qin weight. Ask how fa, posts, rank, pay, fear, and command shaped rule—while rejecting one school, rule-of-law claims, and myths that order made rulers answer to all people.',
  'indian-philosophy': 'Enter a plural South Asian field. Track views of knowledge, words, acts, self, world, and release across rival paths—while testing maps, canons, and labels that falsely give one region a single voice.',
  'buddhist-philosophy': 'Begin with Buddhist paths, not one creed. Track pain, change, no-self, karma, study, practice, and insight across many communities—while texts, images, tongues, and rites carry disputes, aims, and new hopes for release.',
  rationalism: 'Use “rationalism” with care. Compare reason, inborn ideas, necessity, mind, nature, and order—while tracking disputes, experience, debate, and the late label that never once made these thinkers one shared school at all.',
  empiricism: 'Enter empiricism through experiment. Ask how sense, tools, habit, trust, models, and groups test belief—while later labels, pure observation, and claims that experience stands alone hide its social and political frame today.',
  'german-idealism': 'Step beyond Kant’s threshold. Compare post-Kantian views of self, nature, freedom, art, time, and reason—while testing labels, rival systems, partners, and a portrait that shows Kant as precursor but never a member.',
