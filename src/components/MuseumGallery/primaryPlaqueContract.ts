...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  epicurus: 'Meet Epicurus with Metrodorus in a restored Roman herm. Ask how friendship, modest desire, and natural explanation answer fear, while these portraits cannot settle the gods, recreate the Garden, or turn pleasure into luxury.',
  ...
  epictetus: 'Meet a Stoic teacher through Arrian’s mediated Discourses and Handbook, then test the demanding distinction between one’s use of impressions and the external outcomes that still shape duties, vulnerability, and action in shared life.',
  ...
  plotinus: 'Enter Plotinus’s demanding Platonism, where the One, Intellect, and Soul explain dependence without temporal creation, and ethical return requires argument, attention, and transformation rather than escape from a supposedly worthless material world.',
  buddha: 'Approach Siddhartha Gautama through early traditions that diagnose dukkha, craving, and ignorance while training conduct, meditation, and insight—without treating later doctrine or transmitted texts as the directly recorded words of the historical teacher.',
