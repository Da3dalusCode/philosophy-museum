...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  spinoza: 'Enter Spinoza’s single Nature, where mind and body express one order, freedom means understanding necessity, affects reshape power, and scriptural criticism exposes how fear can govern both religious and political life in practice.',
  leibniz: 'Explore Leibniz’s changing system of monads, reasons, harmony, and possible worlds: it seeks unity without physical exchange, but leaves freedom, contingency, divine choice, suffering, and the meaning of explanation still open to dispute.',
  locke: 'Trace Locke’s account of experience, consciousness, rights, and consent, then ask how a politics of property and resistance can challenge arbitrary rule while remaining entangled with exclusion, colonial administration, and dispossession in practice.',
  hume: 'Test Hume’s science of human nature: custom shapes causal belief, passion moves action, sentiment informs judgment, and skepticism returns us to practice—while his own racist hierarchy exposes grave failure within that inquiry.',
  ...
  dostoevsky: 'Enter Dostoevsky’s novels as arguments lived by conflicting voices, where freedom can become spite, theory can excuse cruelty, and active love faces suffering without entirely dissolving Ivan’s protest or the author’s political harms.',
  ...
  husserl: 'Meet Husserl in a lifetime photograph. Ask how intentionality, reduction, lifeworld, and crisis change philosophy, while this uncertain portrait cannot show consciousness, fix his changing method, or complete the unfinished project alone.',
  heidegger: 'Meet Heidegger in a 1960 photograph. Ask how being-in-the-world, care, time, and technology reshape phenomenology, while this portrait cannot prove concepts, end disputes, or sever his philosophy from Nazism and antisemitism alone.',
  sartre: 'Meet Jean-Paul Sartre in a 1965 press photograph. Ask how freedom, facticity, bad faith, and relations with others shape action, while this portrait cannot settle changing political commitments or turn situated responsibility into unlimited choice.',
  camus: 'Meet Albert Camus in a 1957 press photograph. Ask how absurdity, lucid living, revolt, solidarity, and political limits meet, while this Nobel-year portrait cannot resolve colonial contradiction or turn his writing into an existentialist creed.',
  ...
  arendt: 'Meet Hannah Arendt in a 1933 portrait. Ask how statelessness, plurality, action, power, and judgment illuminate political life, while this early image cannot prove a theory, excuse Eichmann, or erase the exclusions critics identify.',
