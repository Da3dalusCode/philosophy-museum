...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  legalism: 'Approach Legalism through a Qin weight. Ask how fa, office, method, rank, reward, and command shaped rule—while rejecting one school, rule-of-law parallels, and tales that order made rulers accountable to all people.',
  ...
  rationalism: 'Use “rationalism” with care. Compare views of reason, innate ideas, necessity, mind, nature, and system—while tracking conflicts, roles for experience, debate, and a later label that never made thinkers one fixed school.',
