...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  eriugena: 'Eriugena made translation into philosophy, bringing Greek Christian arguments into Latin and asking how all things proceed from and return to God without reducing creation to the divine. Explore the Periphyseon’s daring, disputed distinctions.',
  'medieval-scholasticism': 'Scholastic readers questioned old texts, tested objections, and drew careful distinctions in schools and universities. See how translation, close reading, and public debate made shared books the start of new and lasting arguments.',
  ...
  abelard: 'Abelard stages conflicting authorities so readers must test words, contexts, and reasons; he also asks how general terms and moral consent work. Explore dialectic alongside Héloïse’s arguments and the later reception that reshaped their story.',
  aquinas: 'Aquinas tests objections before answering questions about God, creation, virtue, law, and human fulfillment. Follow how his unfinished Summa transforms many inheritances, and why its later authority should not replace reading its arguments.',
  'duns-scotus': 'Scotus asks how one concept of being can support reasoning about God and creatures without erasing difference, and what makes each individual this one. Explore his precise distinctions through a corpus preserved in textual layers.',
