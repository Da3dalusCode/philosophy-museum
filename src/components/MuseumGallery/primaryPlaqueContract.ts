...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  epicureanism: 'Enter the Garden through a carbonized papyrus. Ask how atomism, mortality, desire, friendship, and prudence were joined into a therapy against fear—without mistaking measured pleasure for luxury, isolation, or careless, endless indulgence.',
  cynicism: 'Confront a later scene of Diogenes and Alexander. Ask whether voluntary poverty, frank speech, bodily training, and cosmopolitan challenge can expose dependence on convention—while keeping disputed stories and radical ethics in view.',
  skepticism: 'Open a Renaissance title page of Sextus Empiricus. Compare Academic and Pyrrhonian attempts to oppose arguments, withhold assent, and live amid uncertainty—without turning skepticism into dogmatic denial, passive indecision, or one uniform school.',
  'chinese-philosophy': 'Enter a Warring States bronze vessel’s historical world. Compare rival arguments about cultivation, ritual, benefit, language, power, and change—without turning diverse texts, later transformations, or layered labels into a timeless harmonious worldview.',
  logic: 'Study a nineteenth-century page of Euler diagrams. Ask what valid inference requires, how formal systems clarify and limit reasoning, and why different traditions argue about logic—without making one European teaching page its universal origin.',
  ...
  pragmatism: 'Trace Pragmatism from Peirce’s map of the earth to habits of inquiry. Ask how consequences clarify ideas, why evidence can correct belief, and how democratic experimentation must confront whose experience, harm, and voice count.',
  'analytic-philosophy': 'Meet several analytic founders, then question the portrait collage’s tidy origin story. Follow changing practices of logic, conceptual clarification, language, science, and argument while asking who and what their inherited canon left outside.',
  existentialism: 'Enter Existentialism through a crowded street that predates the movement. Ask how freedom acts within body, history, oppression, and uncertainty, and why responsibility, absurdity, solidarity, and revolt cannot be reduced to private choice.',
  phenomenology: 'Study Cézanne’s shifting table scene, not as a phenomenological illustration, but as an invitation to describe appearance. Ask how objects, bodies, time, and shared worlds become meaningful before abstractions make them seem settled.',
  'continental-philosophy': 'Use this map to question a label rather than locate a doctrine. Trace divergent work on history, embodiment, language, power, and critique, then ask how academic boundaries include, exclude, and simplify philosophical inheritances.',
