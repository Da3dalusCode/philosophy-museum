...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'chinese-philosophy': 'Enter a Warring States bronze world. Compare claims about ritual, learning, language, order, and rule—without making one vessel voice a school, one age define Chinese philosophy, or rival traditions seem harmonious today.',
  ...
  existentialism: 'Enter Existentialism through Munch’s earlier crowd. Ask how freedom meets body, history, oppression, uncertainty, responsibility, solidarity, and revolt—without making one painting prove a doctrine or reducing lived existence to private choice or despair.',
