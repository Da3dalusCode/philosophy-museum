...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'political-philosophy': 'Use this civic fresco to ask what rule owes the public: how should power, justice, liberty, democracy, domination, resistance, and unequal membership reshape the institutions that govern shared life across diverse societies?',
  'merleau-ponty': 'Explore Merleau-Ponty’s lived body: movement, habit, and perception reveal a meaningful world before reflection, while clinical caution and unfinished work keep embodiment from becoming a body diagram or finished theory for readers today.',
  levinas: 'Meet Levinas where another person calls before calculation: responsibility, Saying, justice, and the third party resist turning ethical encounter into empathy, facial appearance, or a private relation without public demands in shared life.',
  gadamer: 'Read Gadamer on tradition and dialogue: prejudgments, horizons, application, and language shape understanding, while ideology critique prevents openness from becoming consensus, a method manual, or trust in every inherited bias we carry today.',
  russell: 'Follow Russell through descriptions, logicism, and public argument: Whitehead’s joint Principia, paradox, changing theories, and political commitments show why analysis never became one final settled system for him or later readers today.',
  frege: 'Enter Frege’s concept-script: logicism, quantification, sense, and reference seek objective thought, while Russell’s paradox ends one derivation without erasing tools that changed later work in logic, language, and arithmetic for modern readers today.',
  ...
  quine: 'Explore Quine’s web of belief: analyticity, translation, ontology, and naturalized inquiry meet experience unevenly, while Carnap’s challenge keeps revision from becoming pure convention or a final scientific verdict for every inquiry today.',
  anscombe: 'Meet Anscombe through intentional action: reasons, practical knowledge, descriptions, and moral seriousness distinguish what agents do from mere movement, prediction, or every foreseen result, while practical knowledge remains fallible in practice today.',
