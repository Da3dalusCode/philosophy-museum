...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  legalism: 'Approach Legalism through a Qin weight. Ask how fa, office, method, incentive, and authority shaped statecraft—while rejecting one school, modern rule-of-law parallels, and mere claims that orderly administration made sovereign power accountable.',
  'indian-philosophy': 'Enter a plural South Asian field. Follow arguments about knowledge, language, action, self, reality, and liberation across rival traditions—while testing every map, canon, and category that pretends one region speaks with one philosophical voice.',
  'buddhist-philosophy': 'Begin with Buddhist paths, not one creed. Trace suffering, change, no-self, karma, discipline, meditation, and insight across communities—while texts, images, languages, and practices carry disputes, adaptations, and new liberating aims over time.',
  rationalism: 'Use “rationalism” carefully. Compare early-modern accounts of reason, innateness, necessity, mind, nature, and system—while tracing conflicting answers, roles for experience, exchange, and a later label that never made thinkers one fixed school.',
  ...
  'german-idealism': 'Step beyond Kant’s critical threshold. Compare post-Kantian arguments about self, nature, freedom, art, history, and reason—while questioning labels, incompatible systems, collaborators, and a portrait marking Kant as precursor but not a member.',
