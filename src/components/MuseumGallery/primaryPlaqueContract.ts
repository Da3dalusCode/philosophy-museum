...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  rawls: 'Use Rawls’s 1971 dust-jacket portrait to enter justice as fairness. Ask how equal liberty, fair opportunity, the difference principle, public reason, and global duties work—and which histories and exclusions still pressure the framework.',
  nozick: 'Meet Nozick through a 1977 magazine portrait. Ask how rights, entitlement, rectification, the minimal state, and voluntary community fit—and why later reservations do not amount to a simple recantation of his political philosophy.',
  ...
  derrida: 'Meet Derrida through a posthumous pencil portrait. Ask how différance, trace, iterability, justice, and hospitality unsettle inherited oppositions, while this imagined likeness cannot make deconstruction arbitrary or resolve the arguments it recalls.',
  ...
  fanon: 'See Fanon speaking at a Tunis press conference whose date remains uncertain. Ask how racialization, psychiatry, colonial violence, organization, and national consciousness shape liberation without reducing his analysis to a timeless defense of force.',
  'jiddu-krishnamurti': 'Meet the young Krishnamurti in a 1920s press portrait. Ask how conditioning, authority, fear, attention, relationship, and education shape freedom—and why this Theosophical-era image cannot represent his mature teaching after the 1929 dissolution.',
  ...
  neoplatonism: 'Study a late-antique sarcophagus relief of a public reader, not an authenticated Plotinus. Ask how unity, intellect, soul, procession, return, commentary, and theurgy differ across traditions later grouped under the imperfect label Neoplatonism.',
  metaphysics: 'Use a new interpretive collage to compare substance, process, identity, possibility, cause, time, and dependence. Ask what kinds of explanation reality permits without treating this illustration—or the modern field name—as one agreed hierarchy.',
