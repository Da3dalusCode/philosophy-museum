...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'anne-conway': 'Enter Van Hoogstraten’s interior, not a secure Conway portrait. Ask how living substance, change, body, spirit, and evil challenge dualism, while the unknown reader cannot prove Conway’s appearance or any biographical claim alone.',
