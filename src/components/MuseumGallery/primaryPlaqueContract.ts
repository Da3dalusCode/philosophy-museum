...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  hegel: 'Meet Hegel in Schlesinger’s 1831 portrait. Ask how recognition, contradiction, institutions, and history shape freedom, while this late likeness cannot compress a changing system or make contested historical claims inevitable for us.',
  bentham: 'Face Bentham’s preserved Auto-Icon. Ask how pleasure, pain, consequences, law, and reform guide utility, while this posthumous display cannot settle whose welfare counts or make calculation morally complete for all affected people.',
  ...
  'philippa-foot': 'Find Foot among Somerville’s 1939 graduates. Ask how virtues, reasons, natural goodness, and practical judgment meet, while this group photograph cannot single out her ideas or make ethical life socially uniform alone.',
  ...
  'feminist-philosophy': 'Enter feminist philosophy through a 1913 suffrage procession. Ask how gender, power, knowledge, work, race, and freedom interact, while one American march cannot represent every feminist tradition, dispute, or political struggle alone.',
