...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'al-ghazali': 'Examine how al-Ghazali used logical and philosophical learning to challenge metaphysical conclusions while joining theology, law, ethics, and spiritual practice—and why that complex project cannot be reduced to a rejection of reason or philosophy.',
  ...
  'zhu-xi': 'Explore Zhu Xi’s demanding path of study, inquiry, ritual, and reverent attention. Trace how pattern and material force shape moral life, then ask when a curriculum educates judgment—and when its authority hardens into orthodoxy.',
  berkeley: 'Examine Berkeley’s challenge to matter, perception, and science: sensible things remain real in an ordered world, yet his immaterialism makes God, active spirits, language, and common sense answerable together to ordinary experience.',
  montesquieu: 'Trace Montesquieu’s comparative inquiry into law: liberty depends on institutions, histories, customs, commerce, climate, and social power, yet explanation can expose domination or offer it dangerous excuses when its limits go unexamined.',
  ...
  wollstonecraft: 'Follow Wollstonecraft from school, marriage, and work into rights and empire. Ask how law makes women seem dependent, and why equal rights must confront class, race, colonial rule, and unequal access to learning.',
