...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  'buddhist-epistemology': 'Watch a Tibetan debate. Ask how Buddhist pramāṇa distinguishes perception, inference, and language; what makes cognition reliable; and why this public practice cannot stand for all Buddhist theories or ancient Indian settings.',
  dignaga: 'Read Dignāga beside a modern relief. Ask how perception, inference, exclusion, and sound reasons guide reliable cognition, while commemoration cannot reveal his life, classroom, or the surviving fragmentary textual record in full.',
  ...
  'wang-yangming': 'Meet Wang Yangming through a Ming portrait. Ask how innate knowing and united knowledge and action reshape moral cultivation, while later remembrance cannot replace his writings, public career, or lasting contested legacy.',
