...
export const PRIMARY_PLAQUE_INVITATION_OVERRIDES = {
  ...
  vasubandhu: 'Meet Vasubandhu through a much later Japanese statue. Ask how Abhidharma and Yogācāra analyze persons, causation, and cognition without a permanent self—and why disputed chronology and corpus boundaries matter to the answer.',
  'buddhist-epistemology': 'Watch a later Tibetan debate and ask how Buddhist pramāṇa traditions distinguish perception, inference, and language; what makes cognition reliable; and why this public practice cannot represent every Buddhist theory or Indian setting.',
  dignaga: 'Read a modern teaching relief beside Dignāga’s fragmentary textual record. Ask how perception, inference, exclusion, and disciplined reasons guide reliable cognition without turning commemoration into a portrait of his life or classroom.',
  dharmakirti: 'Meet Dharmakīrti through a much later Tibetan portrait. Ask how perception, inference, causal efficacy, and successful action make cognition reliable—and why usefulness alone cannot define truth or settle his broader Buddhist aims.',
  'wang-yangming': 'Meet Wang Yangming through a Ming portrait tradition. Ask how innate knowing and the unity of knowledge and action reshape moral cultivation—and why later remembrance cannot replace his writings, career, or contested legacy.',
  'saadia-gaon': 'Enter Saadia Gaon’s world through a restored Cairo synagogue interior. Ask how reason, revelation, law, language, and communal responsibility interact—and why this later setting cannot reconstruct his tenth-century institutions or personal surroundings.',
  'judah-halevi': 'Read Judah Halevi through his own Judeo-Arabic letter about ransoming a prisoner. Ask how poetry, philosophy, covenant, practice, and communal action meet without making one document prove his full thought or final journey.',
  maimonides: 'Study a page in Maimonides’s own hand. Ask how law, argument, negative theology, prophecy, and human perfection guide perplexed readers—and why this legal commentary cannot alone explain the Guide or his wider intellectual world.',
  porphyry: 'Porphyry was a philosopher, editor, commentator, teacher, and practical writer with an unevenly surviving corpus. Enter to encounter more than Plotinus’s editor or Christianity’s opponent: a Platonist who reordered several fields of inquiry.',
  iamblichus: 'Meet Iamblichus through a later copied book. Ask why embodied souls need rites as well as thought, how divine aid shapes return, and what a named voice and broken texts leave unclear today.',
  proclus: 'Proclus integrated systematic metaphysics with commentary, teaching, mathematics, hymns, prayer, and ritual. Enter to move beyond the Elements of Theology and see remaining, procession, and return within a complete philosophical way of life.',
  origen: 'Meet Origen through a later imagined portrait. Ask how scripture and reason address God, freedom, bodies, and return, while lost Greek, Latin copies, fragments, and later attacks keep his changing work hard to fix.',
  augustine: 'Meet Augustine through an early posthumous portrait. Ask how memory, desire, time, creation, evil, grace, and responsibility transform Platonist ascent—and why later reception cannot make his long, changing corpus into one settled system.',
  'gregory-nyssa': 'Gregory of Nyssa connected divine infinity with embodied freedom and perpetual transformation toward the good. Enter to explore body, soul, virtue, resurrection, and the genuine dispute over whether his eschatology culminates in universal restoration.',
  'pseudo-dionysius': 'Read Raphael’s Saint Paul as a clue to a borrowed name, not the author’s face. Ask how divine names, hierarchy, return, and unknowing shaped later Greek and Latin thought across many centuries.',
