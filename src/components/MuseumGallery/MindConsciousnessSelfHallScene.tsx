...
export function MindConsciousnessSelfHallContent({definition, active, nearby, onSelectExhibit, onSceneGesture}: MuseumHallContentProps) {
  return <MuseumHallSpatialRoot definition={definition}>
    ...
    <ContemporaryMuseumExhibits definition={definition} visibleExhibitIds={active ? undefined : ['patanjali', 'vasubandhu']} nearbyId={nearby?.hallId === definition.id ? nearby.exhibitId : undefined} onSelectExhibit={(exhibitId) => onSelectExhibit({hallId: definition.id, exhibitId})}/>
