...
export function EditorialMethodology() {
  return <div className="page methodology-page">
    <header className="methodology-hero">
      ...
      <p>Philosophy Atlas is an independent educational project, not a peer-reviewed journal or an independently reviewed academic publication. Its editorial system makes the state and limits of each page visible instead of treating a bibliography as proof that every sentence has been checked.</p>
    </header>
