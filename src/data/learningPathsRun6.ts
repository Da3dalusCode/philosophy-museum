...
export const expansionRun6LearningPaths: readonly LearningPath[] = [
  {
    ...
    steps: [
      ...
      step({
        ...
        museumLinks: [museum('feminist-philosophies', 'beauvoir', 'Simone de Beauvoir', 'The primary exhibit anchors situation, otherness, embodied freedom, and oppression in Beauvoir’s distinct philosophical project.'), museum('colonialism-race-liberation', 'fanon', 'Frantz Fanon', 'The exhibit relocates lived embodiment within colonial institutions, racialization, psychiatry, and struggles for liberation rather than private introspection.')],
