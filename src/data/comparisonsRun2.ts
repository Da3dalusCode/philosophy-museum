...
export const expansionRun2ComparisonCasefiles: readonly ComparisonCasefile[] = [
  ...
  branchCase(['kantianism', 'german-idealism'], {
    ...
    arguments: [
      {entityId: 'kantianism', title: 'Secure objectivity by limiting claims', summary: statement('By identifying forms and concepts that make possible experience possible, critique aims to explain objective cognition without pretending to know things beyond those conditions.', 'kantianism'), pressure: statement('The boundary must explain affection, things in themselves, freedom, and systematic unity without reintroducing the very dogmatism or skepticism it was meant to avoid.', 'kantianism')},
  ...
  branchCase(['german-idealism', 'marxism'], {
    ...
    sharedAssumptions: [statement('Both reject an isolated, ahistorical subject and treat freedom, reason, and self-understanding as mediated by social relations, practices, conflict, and forms of objectification.', 'german-idealism', 'marxism')],
    axes: [
      {label: 'Motor of development', question: statement('What makes historical forms unstable and capable of transformation?', 'german-idealism', 'marxism'), positions: [
        {entityId: 'german-idealism', claim: statement('German Idealist systems trace development through tensions internal to consciousness, concepts, nature, recognition, and institutions, with major differences among Fichte, Schelling, and Hegel.', 'german-idealism')},
  ...
  branchCase(['feminist-philosophy', 'marxism'], {
    ...
    axes: [
      ...
      ], contrast: statement('Social-reproduction approaches argue that capitalist production depends on life-making activities it often devalues, racializes, feminizes, privatizes, or leaves unpaid.', 'feminist-philosophy', 'marxism')},
    ],
