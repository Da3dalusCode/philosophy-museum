...
const configs: Record<string, ModernClusterEditorialConfig> = {
  bentham: {
    ...
    patch: {
      ...
      dateDisplay: '1748 CE–1832 CE', dateConfidence: 'high', dateNote: 'Birth and death years are secure. Many works circulated late or posthumously, so manuscript date, first publication, translation, and critical-edition date must be distinguished.',
    ...
    reviewNotePath: 'docs/editorial/reviews/bentham.md', reviewLock: 'fnv1a64:960145287e85e988', reviewedOn: '2026-08-03',
  },
  mill: {
    sources: millSources,
    sectionCitations: sections(
    ...
    patch: {
      ...
      dateDisplay: '1806 CE–1873 CE', dateConfidence: 'high', dateNote: 'Birth and death years are secure. Essays often appeared serially or in revised editions; publication date should not be confused with composition or posthumous collection.',
    ...
    reviewNotePath: 'docs/editorial/reviews/mill.md', reviewLock: 'fnv1a64:6e91db417cbab2f2', reviewedOn: '2026-08-03',
  },
  anscombe: {
    ...
    patch: {
      ...
      dateDisplay: '1919 CE–2001 CE', dateConfidence: 'high', dateNote: 'Birth and death dates are secure. Intention first appeared in 1957 and was revised for its 1963 second edition; essay publication and later collection dates should be distinguished.',
    ...
    reviewNotePath: 'docs/editorial/reviews/anscombe.md', reviewLock: 'fnv1a64:b90f7daea8dd6309', reviewedOn: '2026-08-03',
  },
  'iris-murdoch': {
    ...
    patch: {
      ...
      dateDisplay: '1919 CE–1999 CE', dateConfidence: 'high', dateNote: 'Birth and death years are secure. The Sovereignty of Good collects three separately delivered and published essays; it is not a single continuous treatise composed in 1970.',
    ...
    reviewNotePath: 'docs/editorial/reviews/iris-murdoch.md', reviewLock: 'fnv1a64:9650d6c18046fa50', reviewedOn: '2026-08-03',
  },
};
