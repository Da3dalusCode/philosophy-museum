...
const locks: Record<string, string> = {
  ...
  'utility-equality-inclusion': 'fnv1a64:6d4e3eb200089042',
...
const evidence: Record<string, Evidence> = {
  ...
  'utility-equality-inclusion': {
    ...
    claim: 'Public Law 88-38 prohibited sex-based wage differentials for covered equal work under stated conditions and defenses. The SEP account of justice explains that diminishing marginal utility of resources can contingently give utilitarians a reason to favor equality when little is known about recipients, while aggregate welfare alone does not settle distribution, rights, voice, or institutional power.',
    ...
    resolution: 'restored Cecil Stoughton, added NARA identifiers and U.S. rights scope, directly sourced the Act’s limited operative terms, tied the qualified diminishing-marginal-utility claim to the SEP justice analysis, and removed unsupported modern outcome generalizations.',
    additionalSources: [
      source('Public Law 88-38 — Equal Pay Act of 1963, 77 Stat. 56', 'https://www.govinfo.gov/content/pkg/STATUTE-77/pdf/STATUTE-77-Pg56.pdf', 'primary-text'),
      source('Stanford Encyclopedia of Philosophy — Justice, §4.1', 'https://plato.stanford.edu/entries/justice/', 'academic-reference'),
