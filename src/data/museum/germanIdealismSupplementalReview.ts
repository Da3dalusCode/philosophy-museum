...
const evidence: Record<string, ReviewEvidence> = {
  ...
  'nature-goethe-color': {
    ...
    sources: [
      collection('object', 'Wikimedia Commons — Goethe color circle, square derivative', 'https://commons.wikimedia.org/wiki/File:Goethe,_Farbenkreis_zur_Symbolisierung_des_menschlichen_Geistes-_und_Seelenlebens,_1809,_square.jpg'),
      collection('holding', 'Freies Deutsches Hochstift — Goethe’s 1809 watercolor color circle', 'https://freies-deutsches-hochstift.de/en/mediaguide/romantik-ausstellung/2-obergeschoss/runges-farben/farbkreis-zur-symbolisierung-des-menschlichen-geistesund-seelenlebens-1809/'),
      primary('goethe-text', 'Smithsonian Libraries — Goethe, Zur Farbenlehre (1810)', 'https://library.si.edu/digital-library/book/zurfarbenlehre00goeta'),
      academic('goethe-scholarship', 'Goethe-Lexicon — scholarly account of the color circle and reciprocality', 'https://goethe-lexicon.pitt.edu/GL/article/download/52/50'),
      academic('context', 'Stanford Encyclopedia of Philosophy — Schelling', 'https://plato.stanford.edu/entries/schelling/'),
    ],
    guide: [guide('Historic diagram', 'The institutional object record identifies Goethe’s small 1809 watercolor and its six-color symbolic ordering.', 'holding'), guide('Digital crop', 'The square derivative and its CC0 dedication are separate from the underlying object.', 'object'), guide('Perception and optics', 'Goethe’s 1810 text and specialist scholarship support the distinctions among observed phenomena, physical account, and symbolic association.', 'goethe-text', 'goethe-scholarship'), guide('Shared period problem', 'The circle contextualizes Schelling without becoming evidence of his doctrine.', 'goethe-scholarship', 'context')],
  ...
  'hegel-napoleon-jena': {
    ...
    sources: [collection('object', 'Wikimedia Commons — Hegel and Napoleon in Jena illustration', 'https://commons.wikimedia.org/wiki/File:Hegel-and-Napoleon-in-Jena-1806.jpg'), primary('letter', 'Hegel to Niethammer — Jena, 13 October 1806, in Hegel: The Letters', 'https://www.marxists.org/reference/archive/hegel/works/letters/1806-10-13.htm'), academic('context', 'Stanford Encyclopedia of Philosophy — Hegel', 'https://plato.stanford.edu/entries/hegel/')],
    guide: [guide('Published in 1895', 'The picture is a later historicist staging of events associated with 1806.', 'object'), guide('Creator unresolved', 'The available source does not substantiate the legacy Kurtz attribution.', 'object'), guide('World-soul letter', 'Hegel’s letter to Niethammer, dated 13 October 1806, supplies the documented phrase and reconnaissance chronology.', 'letter'), guide('Myth versus evidence', 'A popular slogan and imagined encounter should not replace the letter record.', 'object', 'letter', 'context')],
    resolution: 'Resolved: removed the unverified Kurtz attribution, identified the 1895 reception image, directly sourced Hegel’s 13 October 1806 letter to Niethammer, separated its “world-soul” wording from the later horseback paraphrase, preserved the ratio, mapped claims, and linked the current Hegel article.',
    lock: 'fnv1a64:eddebcfbeaf0f4a7',
  },
