...
const locks: Record<string, string> = {
  ...
  'moore-open-question': 'fnv1a64:143c5fab811f8f3f',
  ...
  'wittgenstein-investigations': 'fnv1a64:2fab21f413f9d555',
  'wittgenstein-language-games': 'fnv1a64:14a0190858a7d065',
  'quine-two-dogmas': 'fnv1a64:250d70acf1b9e576',
  ...
  'anscombe-intention-why': 'fnv1a64:25b7ae1a617169dd',
  ...
  'phenomenology-intentionality': 'fnv1a64:508eb60dfd175252',
  ...
  'levinas-ethics-before-ontology': 'fnv1a64:65d9cfdd15a6a980',
...
const evidence: Record<string, Evidence> = {
  ...
  'moore-open-question': {
    ...
    visualReading: 'The constructed scene juxtaposes measurable features with an unresolved evaluative prompt; every element is a 2026 interpretive choice rather than historical evidence.',
    ...
    resolution: 'retained explicit ImageGen authorship and internal provenance while tightening the distinction among visual prompt, open-question reasoning, and contested metaphysical conclusions.',
  },
  'moore-common-sense': {
  ...
  'wittgenstein-investigations': {
    ...
    invitation: 'A 2022 landscape photograph records the reconstructed Skjolden house and site, not the 1953 Investigations edition formerly associated with this asset ID.',
    ...
    claim: 'Wittgenstein worked repeatedly at Skjolden, and ideas developed across his later work entered Philosophical Investigations. Site history supports a biographical connection, not authorship of a specific passage in view.',
    boundary: 'Mia1964 photographed the reconstructed, returned building on 3 October 2022 under CC BY-SA 4.0. It is a present-day site image and not a book cover, primary manuscript, or 1930s fabric survey.',
    guide: ['Read the image as a reconstructed place with monument number 247129, not the 1953 bilingual edition.', 'Connect place and work only through biographical sources; the landscape cannot establish a doctrine or composition date.'],
    resolution: 'replaced the stale book-cover account with the actual Skjolden landscape, reconstruction status, 2022 authorship and license, and bounded biographical inference.',
    leadOverride: 'The mounted object is Mia1964’s 2022 photograph of the reconstructed house at Skjolden where Wittgenstein worked during several periods. It is not the cover of Philosophical Investigations and does not display Anscombe’s translation. The posthumous 1953 book reorganizes philosophy around language-games, use, family resemblance, rule-following, and forms of life. Biographical sources connect Wittgenstein’s Norwegian work periods to his developing thought, but the distant building cannot assign a sentence, doctrine, or date to what occurred there.',
  },
  'wittgenstein-language-games': {
    ...
    invitation: 'A 2026 Museum collage gathers recurring examples while declaring itself an interpretation rather than Wittgenstein’s diagram.',
    ...
    boundary: 'The internal ImageGen asset has no independent accession or outside provenance. “Meaning is use” is an orientation, not an exhaustive formula, and contested social readings should not be presented as direct quotation.',
  ...
  'quine-two-dogmas': {
    ...
    boundary: 'The self-hosted ImageGen illustration has no external provenance or accession. It cannot prove that logic is revised casually, that any response is equally rational, or that Quine supplied this exact web.',
  ...
  'anscombe-intention-why': {
    ...
    boundary: 'The 2026 ImageGen illustration has internal provenance only and is not Anscombe’s diagram. The pump case must be read in the text, including the possibility that an agent lacks knowledge of wider effects.',
  ...
  'phenomenology-intentionality': {
    ...
    invitation: 'A 2026 Museum collage interprets profiles and horizons without claiming to be a historical Husserl diagram or an inner picture of consciousness.',
    ...
    boundary: 'The ImageGen asset has internal provenance only. It cannot establish realism or idealism, reduce intentionality to vision, or assign every surrounding phenomenological development to Husserl alone.',
  ...
  'heidegger-being-time': {
    ...
    boundary: 'The internal ImageGen asset has no external accession and cannot prove the analysis or substitute authenticity for ethics. Heidegger’s Nazi Party membership, rectorship, and antisemitic passages remain essential critical context.',
  ...
  'merleau-phenomenology-perception': {
    ...
    boundary: 'The ImageGen asset has internal provenance only. It must not anonymize disabled people, turn clinical cases into spectacle, or collapse Merleau-Ponty into later embodied-cognition programs.',
  ...
  'existentialism-facticity-freedom': {
    ...
    boundary: 'The internal ImageGen asset has no external accession and cannot distribute responsibility, quantify constraint, or represent every existentialist and situated person.',
  ...
  'sartre-bad-faith': {
    ...
    invitation: 'A 2026 Museum scene interprets self-presentation and another’s look without reducing bad faith to lying or one theatrical gesture.',
    ...
    boundary: 'The internal ImageGen asset has no outside provenance or accession and is not Sartre’s diagram. It cannot establish another person’s motives from appearance or excuse deception and domination.',
  ...
  'levinas-ethics-before-ontology': {
    ...
    boundary: 'The installed asset is a 2026 Philosophy Atlas/OpenAI ImageGen work with internal source-art provenance, not the 2002 German cover formerly attached to the legacy ID and not historical evidence about Levinas.',
    ...
    resolution: 'replaced the stale German-edition account with the actual generated social scene and bounded face, alterity, rescue, provenance, and evidentiary claims.',
    leadOverride: 'The installed image is Interrupted Passage, a 2026 Philosophy Atlas Museum interpretation made with OpenAI image generation. It is not a German cover of Totality and Infinity, a documentary photograph, or a portrait of Levinas. The scene of one passerby stopping before an exhausted stranger offers a visual prompt for ethical interruption. Levinas’s “face” is not reducible to visible features, and no staged act can prove his claim that responsibility precedes theoretical mastery. The argument must be read in the text and its critical reception.',
  },
  'levinas-saying-said': {
...
const visualReview = (id: string): NonNullable<NonNullable<MuseumSupplementalExhibit['review']>['visualReview']> => ({
  ...
  mobile: {reviewedOn: '2026-08-20', viewport: '390×844', evidence: `Direct route inspected with a wrapped factual title, aspect-safe object preview, scrollable interpretation, complete controls, and no horizontal overflow. Evidence: docs/visual-validation/gallery-20-21-supplementals/mobile/${id}.png`},
