...
export const JUSTICE_SUPPLEMENTAL_EXHIBITS = [
  ...
  justiceExhibit({
    ...
    lead: 'Arendt attended Adolf Eichmann’s 1961 trial in Jerusalem and later described a “banality of evil”: not that Nazi crimes were trivial, but that Eichmann appeared frighteningly ordinary, reliant on clichés, career logic, and failures of judgment. Her report provoked intense disputes about Eichmann’s motives, Jewish councils, the trial, and the adequacy of her evidence and tone. The courtroom photograph is documentary evidence of the proceeding, not a portrait of Arendt’s conclusions and not an invitation to center the perpetrator over victims. It should direct attention toward responsibility within institutions while preserving the historical specificity of the Holocaust.',
    keyIdeas: [
