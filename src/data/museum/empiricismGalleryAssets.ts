...
export const EMPIRICISM_GALLERY_ASSETS = [
  asset({
    id: 'empiricism-hooke-micrographia-flea', entityKind: 'branch', entityId: 'empiricism', role: 'material-history', mediaKind: 'book-page', visualCharacter: 'map-or-diagram',
    title: 'Open copy of Micrographia showing the flea plate', creator: 'Robert Hooke; unidentified engraver', imageCreator: 'Wellcome Collection', objectDate: 'Book published 1665; collection photograph date unrecorded', institution: 'Wellcome Collection, image L0043503', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Robert_Hooke,_Micrographia,_flea_Wellcome_L0043503.jpg', objectPageUrl: 'https://wellcomecollection.org/works/ajveb66y/items', ...ccBy4, derivativeNotice,
    attribution: 'Open copy of Robert Hooke’s Micrographia showing the 1665 flea plate; Wellcome Collection image L0043503, CC BY 4.0.', scene: [640, 383], panel: [1280, 766],
    alt: 'An open Micrographia volume shows printed text on the left and Hooke’s large fold-out engraved flea extending across the right-hand pages.',
    caption: 'A Wellcome Collection photograph records an open copy of Micrographia displaying Hooke’s 1665 fold-out flea plate.',
    historicalNote: 'The installed bytes show a later color photograph of an open volume, not the detached engraving alone. The plate translates microscope observations through specimen preparation, lenses, drawing, engraving, folding, publication, photography, and reader judgment.',
  ...
  asset({
    ...
    historicalNote: 'Painted before Molyneux posed his question, the work is a period visual companion rather than an illustration of Locke, Molyneux, Cheselden, or a restored-vision experiment. The museum reserves rights in its current digital image while the installed Commons derivative carries a Public Domain Mark; those source-chain statements are not interchangeable.',
  ...
  asset({
    ...
    title: 'A Cobbler in His Workshop', creator: 'David Teniers the Younger', objectDate: '1671', institution: 'Present holding unverified; private-market record reproduced by Wikimedia Commons', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:David_Teniers_(II)_-_A_cobbler_in_his_workshop.jpg', ...publicDomain, derivativeNotice,
    ...
    historicalNote: 'Teniers did not paint Locke’s example. The source supports the artist, title, date, and medium, but not a responsible present custody or provenance chain; the scene is contextual evidence for skilled labor and social rank.',
    likenessStatus: 'not-applicable',
  }),
  asset({
  ...
  asset({
    ...
    caption: 'A near-contemporary map supplies colonial cartographic context for disputed relations among land, government, dispossession, and slavery.',
  ...
  asset({
    ...
    title: 'Instrument for perspective drawing', creator: 'Jobst Bürgi', imageCreator: 'Wolfgang Sauber (Commons user Xenophon)', objectDate: '1604 (?); photograph made 2010', institution: 'Kunsthistorisches Museum Vienna, Kunstkammer, KK 788', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Perspektive_Zeichenger%C3%A4t.jpg', objectPageUrl: 'https://www.khm.at/en/artworks/perspective-drawing-device-86987', ...ccBySa3, derivativeNotice,
  ...
  asset({
    ...
    title: 'The Bermuda Group (Dean Berkeley and His Entourage)', creator: 'John Smibert', objectDate: 'Begun 1728; reworked 1739', institution: 'Yale University Art Gallery, 1808.1', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:John_Smibert_-_The_Bermuda_Group_(Dean_Berkeley_and_His_Entourage)_-_1808.1_-_Yale_University_Art_Gallery.jpg', objectPageUrl: 'https://artgallery.yale.edu/collections/objects/21', ...publicDomain, derivativeNotice,
    attribution: 'John Smibert, The Bermuda Group, begun 1728 and reworked 1739, Yale University Art Gallery. Public Domain Mark 1.0 reproduction via Wikimedia Commons.', scene: [640, 478], panel: [1280, 955],
    alt: 'George Berkeley, Anne and Henry Berkeley, John Smibert, and other adults and children assemble in a large group portrait associated with the Bermuda college scheme.',
    caption: 'Smibert’s group portrait is associated with the unbuilt Bermuda college scheme and its family and patronage network.',
    historicalNote: 'The planned college was never built. Yale applies terms to its current institutional image while the installed Commons derivative is marked public domain. Whitehall was Berkeley’s Rhode Island estate, where documentary research establishes his slaveholding; the portrait does not prove each sitter’s exact role.',
  ...
  asset({
    ...
    title: 'The Camera Obscura', creator: 'Charles-Amédée-Philippe van Loo', objectDate: '1764', institution: 'National Gallery of Art, Washington, 1945.10.1', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Van_Loo_The_Camera_Obscura_1764.jpg', objectPageUrl: 'https://www.nga.gov/artworks/32578-camera-obscura', ...publicDomain, derivativeNotice,
    ...
    alt: 'A seated woman and two children peer through an oval opening in a wooden camera obscura while a projected image appears inside the darkened device.',
    caption: 'Van Loo’s 1764 painting shows a woman and two children examining a camera obscura through its oval viewing opening.',
    historicalNote: 'Painted after Berkeley’s major works, this is later contextual analogy rather than his model or historical evidence for his theory. The National Gallery of Art identifies accession 1945.10.1 and releases its media as public domain.',
  ...
  asset({
    ...
    alt: 'Three animated players lean over a backgammon board and gesture amid counters, dice, and rich fabrics.',
  ...
  asset({
    ...
    title: 'The “Heart of Midlothian,” High Street, Edinburgh', creator: 'W. & A. K. Johnston', objectDate: '1852 reconstruction of the eighteenth-century street', institution: 'Publication recorded; present holding institution unverified', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:The_%27Heart_of_Midlothian%27,_High_Street,_Edinburgh.jpg', ...publicDomain, derivativeNotice,
