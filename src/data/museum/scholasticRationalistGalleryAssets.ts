...
export const SCHOLASTIC_RATIONALIST_GALLERY_ASSETS = [
  ...
  asset({
    ...
    title: 'Benedictus de Spinoza', creator: 'Unknown engraver', objectDate: 'Amsterdam, 1677', institution: 'Published with Nagelate Schriften van B.d.S.', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Engraving_of_Spinoza,_Nagelate_Schriften_van_B.d.S._Amsterdam_1677.jpg', ...publicDomain, derivativeNotice,
    ...
    alt: 'A posthumous oval engraving depicts Spinoza with shoulder-length curls above a Dutch memorial poem.', caption: 'The portrait issued with the 1677 Dutch posthumous writings helped establish Spinoza’s public image.', historicalNote: 'Published in the year of Spinoza’s death, this is early posthumous reception rather than a documented portrait sitting. The Commons record attributes the underlying work broadly to Spinoza, but the engraver is not identified.', likenessStatus: 'posthumous-portrait', focalPoint: {x: .5, y: .3},
  }),
  asset({
