...
export const SCHOLASTIC_RATIONALIST_GALLERY_ASSETS = [
  ...
  asset({
    id: 'rationalism-conway-principia', folder: 'rationalism-mind-nature-system', entityKind: 'philosopher', entityId: 'anne-conway', role: 'context', mediaKind: 'book-page',
  ...
  asset({
    id: 'rationalism-leibniz-correspondence', folder: 'rationalism-mind-nature-system', entityKind: 'philosopher', entityId: 'leibniz', role: 'context', mediaKind: 'manuscript',
  ...
  asset({
    id: 'rationalism-leibniz-new-essays', folder: 'rationalism-mind-nature-system', entityKind: 'philosopher', entityId: 'leibniz', role: 'context', mediaKind: 'book-page',
  ...
  asset({
    ...
    title: 'Ethica, Part I: axioms and propositions I–IV', creator: 'Benedictus de Spinoza', objectDate: 'Represented as 1677, Opera posthuma', institution: 'Wikimedia Commons reproduction; holding institution and shelfmark not supplied', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Spinoza_Ethica_Pars1_Prop1.jpg', ...publicDomain, derivativeNotice,
    attribution: 'Typeset page represented as Benedictus de Spinoza, Ethica, Part I, Opera posthuma, 1677; holding copy unrecorded. Public Domain Mark 1.0.', scene: [640, 479], panel: [949, 711],
    alt: 'A wide Latin typeset page represented as Part I of Spinoza’s Ethics sets axioms and propositions I–IV in compact print.', caption: 'Part I axioms and opening propositions on a page represented as the 1677 Opera posthuma; no holding copy or shelfmark is supplied.', historicalNote: 'The source identifies the page with the posthumous Ethics but cites no institutional copy record. It witnesses geometric organization without establishing a unique first-edition exemplar or autograph, and the format does not make philosophical conclusions uncontested mathematics.', likenessStatus: 'not-applicable',
  }),
  asset({
    id: 'rationalism-tractatus-manuscript-note', folder: 'rationalism-mind-nature-system', entityKind: 'philosopher', entityId: 'spinoza', role: 'context', mediaKind: 'manuscript',
