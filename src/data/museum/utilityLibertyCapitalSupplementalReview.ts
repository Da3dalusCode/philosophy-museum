...
const evidence: Record<string, ReviewEvidence> = {
  ...
  'liberty-harriet-collaboration': {
    ...
    additions: [
      ...
      'Taylor and Mill met in 1830, continued an intellectual relationship while she remained married to John Taylor, and married in 1851 after Taylor’s 1849 death. Her Enfranchisement of Women, correspondence, and Mill’s acknowledgements support substantial participation; scholarship still disputes the exact scope of collaboration on individual works, especially On Liberty.',
    ...
    sources: [collection('object', 'National Portrait Gallery — Harriet Mill, NPG 5489', 'https://www.npg.org.uk/collections/search/portrait?mkey=mw07681'), collection('rights', 'Wikimedia Commons — Harriet Mill reproduction and rights caveat', 'https://commons.wikimedia.org/wiki/File:Harriet_Mill_from_NPG.jpg'), academic('harriet-scholarship', 'Stanford Encyclopedia of Philosophy — Harriet Taylor Mill', 'https://plato.stanford.edu/entries/harriet-mill/'), academic('context', 'Stanford Encyclopedia of Philosophy — Mill’s Moral and Political Philosophy', 'https://plato.stanford.edu/entries/mill-moral-political/')],
    guide: [guide('Catalogued c. 1834', 'The artist is unknown, but the NPG does supply an approximate date and medium.', 'object'), guide('Gift and reproduction', 'Hayek gave the work in 1982; the digital reproduction has a separate rights caveat.', 'object', 'rights'), guide('Relationship chronology', 'Taylor and Mill met in 1830; John Taylor died in 1849; Taylor and Mill married in 1851.', 'harriet-scholarship'), guide('Attribution discipline', 'Collaboration should be credited without inventing sentence-level coauthorship; Enfranchisement and On Liberty require work-specific qualification.', 'harriet-scholarship', 'context')],
    resolution: 'Resolved: corrected the false unknown-date caution to the NPG’s c. 1834 date, added medium, accession and Hayek gift, retained the unknown artist and reproduction-rights caveat, directly sourced the 1830–1849–1851 relationship chronology and work-specific attribution disputes, preserved the ratio, mapped claims, and linked the current John Stuart Mill article.',
    lock: 'fnv1a64:43e92c9417346de2',
  },
  ...
  'liberty-imperial-exception': {
    ...
    additions: [
      ...
      'Chapter I of On Liberty limits Mill’s liberty principle to people he considers capable of improvement through free discussion and calls despotism legitimate for those he labels “barbarians” when aimed at improvement. His East India Company career and later discussion of dependencies place that civilizational hierarchy inside an imperial institution.',
    ...
    sources: [collection('object', 'Wikimedia Commons — East India Company coins, National Museum, New Delhi', 'https://commons.wikimedia.org/wiki/File:East_India_Company_coins_-_National_Museum,_New_Delhi_-_IMG_2224.jpg'), primary('liberty-primary', 'Mill — On Liberty, Chapter I', 'https://oll.libertyfund.org/titles/mill-on-liberty-and-the-subjection-of-women-1879-ed?html=true'), primary('dependencies', 'Mill — Considerations on Representative Government', 'https://oll.libertyfund.org/title/mill-considerations-on-representative-government'), academic('context', 'Stanford Encyclopedia of Philosophy — John Stuart Mill', 'https://plato.stanford.edu/entries/mill/')],
    guide: [guide('Display, not one coin', 'The photograph shows assorted objects with regional labels rather than a single dated issue.', 'object'), guide('Provenance limit', 'Individual accessions, dates, makers, and coin histories are not legible from the installed image.', 'object'), guide('On Liberty exception', 'Chapter I states the despotism and “barbarians” exception inside the work that announces the liberty principle.', 'liberty-primary'), guide('Government of dependencies', 'Mill’s representative-government text extends a civilizational readiness framework to dependencies.', 'dependencies', 'context')],
    resolution: 'Resolved: identified the 2010 museum-display photograph, removed singular-coin and undocumented accession claims, separated photographer rights from object histories, directly mapped the despotism and “barbarians” formulation to On Liberty Chapter I, preserved the separate dependencies source, preserved the ratio, and linked the current John Stuart Mill article.',
    lock: 'fnv1a64:7319646a5b316fa4',
  },
