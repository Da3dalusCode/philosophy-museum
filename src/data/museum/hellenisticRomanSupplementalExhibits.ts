...
const record = (input: ReviewedSupplementalInput): MuseumSupplementalExhibit => {
  ...
  return {
    ...
    review: {
      ...
      method: 'Gallery 02 supplemental review: object identity, claims, source mapping, rights, accessibility, provenance, and the established untitled object-led exhibit presentation.',
...
export const HELLENISTIC_ROMAN_SUPPLEMENTAL_EXHIBITS = [
  record({
    ...
    resolution: 'Resolved: identified van Mol’s painting as early-modern reception, corrected the image description, and mapped the lamp anecdote and Cynic frank speech to their distinct ancient and scholarly evidence.', lock: 'fnv1a64:a50c09c755e56c85',
  }),
  record({
    ...
    resolution: 'Resolved: corrected the 1643 Rijksmuseum print’s maker and design credit, distinguished its marriage-proposal scene from ancient evidence, and mapped the Hipparchia–Crates account to Diogenes Laertius with explicit uncertainty.', lock: 'fnv1a64:b81fecc4c8771e13',
  }),
  record({
    ...
    resolution: 'Resolved: recast the portrait grid as nineteenth-century reception, mapped Diogenes’s attributed kosmopolitēs reply and the disputed Cynic lineage, and separated Cynic refusal from later Stoic cosmopolitan theory.', lock: 'fnv1a64:37beb2e21b4e1ed7',
  }),
  record({
    ...
    resolution: 'Resolved: retitled the exhibit around the installed Oinoanda fragment, corrected its identity, credit, rights, dimensions, and accessibility text, and mapped its public Epicurean teaching to primary and scholarly evidence.', lock: 'fnv1a64:fb60ca5d1cef6a1a',
  }),
  record({
    ...
    resolution: 'Resolved: identified the installed Athena and its licensed photograph, recast it as truthful Villa material context, and qualified every claim connecting the library, Philodemus, residence, ownership, and Roman patronage.', lock: 'fnv1a64:c861e417a99a10e3',
  }),
  record({
    ...
    resolution: 'Resolved: identified the displayed object as Castrucci’s 1858 diagram of Piaggio’s unrolling machine, corrected its provenance and accessibility record, and mapped the conservation claims to documented material limits.', lock: 'fnv1a64:baa48433506792e4',
  }),
  record({
    ...
    resolution: 'Resolved: identified the installed Pyrrho storm drawing and its public-domain record, corrected the anecdote to Diogenes Laertius 9.68, and distinguished reception, Pyrrho’s contested views, and Sextus’s later practice.', lock: 'fnv1a64:03890976f5488a09',
  }),
