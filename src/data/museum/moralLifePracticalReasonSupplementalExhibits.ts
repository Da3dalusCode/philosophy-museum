...
export const MORAL_LIFE_PRACTICAL_REASON_SUPPLEMENTAL_EXHIBITS = [
  ...
  curated({
    ...
    entityKind: 'philosopher',
    displayName: 'Natural Goodness Without a Moral Ledger',
    shortTitle: 'Foot on Natural Goodness',
    ...
    question: 'Can judgments about human goodness be objective because they concern what humans characteristically need and do?',
  ...
  curated({
    ...
    entityKind: 'philosopher',
    displayName: 'The Violinist and Bodily Authority',
    shortTitle: 'Thomson’s Violinist',
    ...
    question: 'Does another person’s need for one’s body automatically create a right to its continued use?',
  ...
  curated({
    ...
    parent: 'judith-thomson',
    entityKind: 'philosopher',
    displayName: 'Bodily Authority in a Political Field',
    shortTitle: 'Rights Beyond the Isolated Case',
    ...
    question: 'How do precisely framed rights cases change when bodily choices are structured by law, work, medicine, and unequal power?',
  ...
  curated({
    ...
    parent: 'derek-parfit',
    entityKind: 'philosopher',
    displayName: 'What Matters Across a Life?',
    shortTitle: 'Psychological Continuity',
  ...
  curated({
    ...
    parent: 'derek-parfit',
    entityKind: 'philosopher',
    displayName: 'Reasons for People Who May Exist',
    shortTitle: 'Future Generations',
