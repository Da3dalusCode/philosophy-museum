...
export const MORAL_LIFE_PRACTICAL_REASON_SUPPLEMENTAL_EXHIBITS = ([
  ...
  curated({
    ...
    ideas: [
      ...
      'Utilitarians disagree about equality, rights, rules, opportunities, and what counts as welfare. Where material resources have diminishing marginal utility, transferring an additional unit toward someone with less can contingently favor a more equal distribution; aggregate utility still contains no independent guarantee of equality. Mill’s arguments for women’s equality and liberty likewise complicate utility as a bare sum without resolving every tension between aggregation and justice.',
      'Public Law 88-38 prohibited covered employers from sex-based wage differentials for equal work requiring equal skill, effort, and responsibility under similar working conditions, subject to stated defenses. The signing photograph establishes enactment, not coverage in a particular case, enforcement, litigation, amendment, wage-gap measurement, or later outcomes; those require separate legal and empirical evidence.',
    ],
    cautions: [
