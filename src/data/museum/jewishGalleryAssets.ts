...
export const JEWISH_GALLERY_ASSETS = [
  ...
  asset({
    ...
    title: 'Guide for the Perplexed manuscript illumination', creator: 'Ferrer Bassa', objectDate: 'Barcelona, 1348', institution: 'Royal Danish Library',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:14c_ed_of_the_Guide_for_the_Perplexed_by_Maimonides.jpg', ...publicDomain,
    attribution: 'Ferrer Bassa, illumination in a 1348 Guide for the Perplexed manuscript, Royal Danish Library. Public domain.',
  ...
  asset({
    ...
    title: 'Arabic manuscript of the Guide to the Perplexed', creator: 'Maimonides; copyist unknown', objectDate: 'Egypt, about 1200–1400', institution: 'National Library of Israel / World Digital Library',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:The_Guide_to_the_Perplexed_WDL3963.pdf', ...publicDomain,
    attribution: 'Maimonides, Arabic Guide to the Perplexed, later Egyptian manuscript, National Library of Israel. Public domain.',
    scene: [432, 640], panel: [500, 741],
    alt: 'A manuscript opening carries the Guide’s Arabic text in dark script with rubrication and marginal marks.',
    caption: 'A later Arabic manuscript witness to the Guide before and alongside its Hebrew and Latin afterlives.',
    historicalNote: 'The copyist and exact date are unknown; the manuscript should not be called Maimonides’s autograph or assigned a false precision.',
    likenessStatus: 'not-applicable',
  }),
  asset({
    id: 'moses-mendelssohn-rijksmuseum', entityKind: 'philosopher', entityId: 'maimonides', role: 'context', mediaKind: 'engraving',
    title: 'Portrait of Moses Mendelssohn', creator: 'Johann Gotthard Müller after Johann Christoph Frisch', objectDate: 'About 1770–1775', institution: 'Rijksmuseum, RP-P-1907-2896',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Portret_van_Moses_Mendelssohn,_RP-P-1907-2896.jpg', ...cc0,
    derivativeNotice,
    attribution: 'Johann Gotthard Müller after Johann Christoph Frisch, portrait of Moses Mendelssohn, Rijksmuseum, CC0.',
