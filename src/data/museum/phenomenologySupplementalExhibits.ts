...
export const PHENOMENOLOGY_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  ...
  layout({id: 'gadamer-art-play-truth', parentExhibitId: 'gadamer', zoneId: 'phenomenology-interpretation-alterity', position: {x: 5.55, z: 17.42}, rotationY: 0, assetId: 'gadamer-lepanto-conversation', mediaWidth: 2.2 * 640 / 323, mediaHeight: 2.2, installationKind: 'phenomenology-concept', accent: PHENOMENOLOGY_PALETTE.midnight}),
