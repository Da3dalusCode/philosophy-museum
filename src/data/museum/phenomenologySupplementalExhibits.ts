...
import {reviewPhenomenologySupplementalExhibit} from './gallery20And21SupplementalReview';
import type {
...
] as const satisfies readonly MuseumSupplementalExhibit[]).map(reviewPhenomenologySupplementalExhibit);

export const PHENOMENOLOGY_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  layout({id: 'phenomenology-intentionality', parentExhibitId: 'phenomenology', zoneId: 'phenomenology-method', position: {x: -5.55, z: -17.42}, rotationY: Math.PI, assetId: 'phenomenology-intentionality-interpretive', mediaWidth: 3.2 * 512 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-concept', accent: PHENOMENOLOGY_PALETTE.horizon}),
  layout({id: 'husserl-crisis-lifeworld', parentExhibitId: 'husserl', zoneId: 'phenomenology-method', position: {x: 5.55, z: -17.42}, rotationY: Math.PI, assetId: 'husserl-lifeworld-atget-pavers', mediaWidth: 3.2 * 475 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.midnight}),
  layout({id: 'heidegger-being-time', parentExhibitId: 'heidegger', zoneId: 'phenomenology-being-embodiment', position: {x: -5.55, z: -6.22}, rotationY: Math.PI, assetId: 'heidegger-being-time-interpretive', mediaWidth: 2.1, mediaHeight: 2.1 * 640 / 409, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.midnight}),
  layout({id: 'merleau-phenomenology-perception', parentExhibitId: 'merleau-ponty', zoneId: 'phenomenology-being-embodiment', position: {x: 5.55, z: -6.22}, rotationY: Math.PI, assetId: 'merleau-perception-interpretive', mediaWidth: 2.1, mediaHeight: 2.1 * 640 / 384, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.flesh}),
  layout({id: 'existentialism-facticity-freedom', parentExhibitId: 'existentialism', zoneId: 'existentialism-freedom', position: {x: -5.55, z: 4.98}, rotationY: Math.PI, assetId: 'existentialism-situated-freedom-interpretive', mediaWidth: 3.2 * 512 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-concept', accent: PHENOMENOLOGY_PALETTE.ambiguity}),
  layout({id: 'existentialism-kierkegaard-precursor', parentExhibitId: 'existentialism', zoneId: 'existentialism-freedom', position: {x: -11.38, z: 0}, rotationY: Math.PI / 2, assetId: 'existentialism-kierkegaard-copenhagen-street', mediaWidth: 2.2 * 640 / 421, mediaHeight: 2.2, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.horizon}),
  layout({id: 'sartre-bad-faith', parentExhibitId: 'sartre', zoneId: 'existentialism-freedom', position: {x: 5.55, z: 4.98}, rotationY: Math.PI, assetId: 'sartre-bad-faith-look-interpretive', mediaWidth: 3.2 * 512 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.flesh}),
  ...
  layout({id: 'heidegger-being-with', parentExhibitId: 'heidegger', zoneId: 'phenomenology-being-embodiment', position: {x: -5.55, z: -16.18}, rotationY: 0, assetId: 'heidegger-being-with-crowd-1923', mediaWidth: 3.2, mediaHeight: 3.2 * 496 / 640, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.midnight}),
  layout({id: 'merleau-flesh-reversibility', parentExhibitId: 'merleau-ponty', zoneId: 'phenomenology-being-embodiment', position: {x: 5.55, z: -16.18}, rotationY: 0, assetId: 'merleau-flesh-rodin-cathedral', mediaWidth: 3.2 * 505 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.flesh}),
  layout({id: 'camus-plague-solidarity', parentExhibitId: 'camus', zoneId: 'existentialism-situated-absurd', position: {x: -5.55, z: 6.22}, rotationY: 0, assetId: 'camus-plague-oran-port-1943', mediaWidth: 2.2 * 640 / 347, mediaHeight: 2.2, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.horizon}),
  layout({id: 'beauvoir-second-sex', parentExhibitId: 'existentialism', zoneId: 'existentialism-situated-absurd', position: {x: 5.55, z: 6.22}, rotationY: 0, assetId: 'beauvoir-suffrage-poster-1924', mediaWidth: 3.2 * 465 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.ambiguity}),
  layout({id: 'fanon-colonial-experience', parentExhibitId: 'camus', zoneId: 'existentialism-situated-absurd', position: {x: 11.38, z: 11.2}, rotationY: -Math.PI / 2, assetId: 'fanon-portrait', mediaWidth: 3.2 * 461 / 640, mediaHeight: 3.2, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.alterity}),
  layout({id: 'levinas-saying-said', parentExhibitId: 'levinas', zoneId: 'phenomenology-interpretation-alterity', position: {x: -5.55, z: 17.42}, rotationY: 0, assetId: 'levinas-signature-1983', mediaWidth: 3.2, mediaHeight: 3.2 * 630 / 640, installationKind: 'phenomenology-work', accent: PHENOMENOLOGY_PALETTE.alterity}),
  layout({id: 'gadamer-art-play-truth', parentExhibitId: 'gadamer', zoneId: 'phenomenology-interpretation-alterity', position: {x: 5.55, z: 17.42}, rotationY: 0, assetId: 'gadamer-lepanto-conversation', mediaWidth: 2.2 * 640 / 323, mediaHeight: 2.2, installationKind: 'phenomenology-concept', accent: PHENOMENOLOGY_PALETTE.midnight, width: 4.56}),
