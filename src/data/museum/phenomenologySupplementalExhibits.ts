...
export const PHENOMENOLOGY_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  ...
  layout({id: 'beauvoir-ethics-ambiguity', parentExhibitId: 'existentialism', zoneId: 'existentialism-situated-absurd', position: {x: 5.55, z: 16.18}, rotationY: Math.PI, assetId: 'beauvoir-gpo-1967', mediaWidth: 2.42, mediaHeight: 3.22, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.ambiguity}),
  ...
  layout({id: 'beauvoir-second-sex', parentExhibitId: 'existentialism', zoneId: 'existentialism-situated-absurd', position: {x: 5.55, z: 6.22}, rotationY: 0, assetId: 'beauvoir-suffrage-poster-1924', mediaWidth: 2.34, mediaHeight: 3.22, installationKind: 'phenomenology-context', accent: PHENOMENOLOGY_PALETTE.ambiguity}),
