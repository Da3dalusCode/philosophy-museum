...
export const COLONIALISM_RACE_LIBERATION_GALLERY_ASSETS = [
  ...
  asset({
    ...
    creator: 'Unknown photographer',
    objectDate: 'Described as 1958; Commons records only “before 1984”',
    institution: 'National Archives of Tunisia attribution via Wikimedia Commons; no archive identifier or original publication record supplied',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:R%C3%A9fugi%C3%A9s_algeriens_dans_des_grottes_1958_(cropped).jpg',
    rights: {license: 'Commons asserts public domain in Tunisia for a photographic work made before July 1984; original publication and archive record remain unverified', licenseUrl: 'https://commons.wikimedia.org/wiki/File:R%C3%A9fugi%C3%A9s_algeriens_dans_des_grottes_1958_(cropped).jpg', rightsKind: 'rights-status'},
    attribution: 'Unknown photographer, people described in the filename as Algerian refugees sheltering in caves in 1958. Commons supplies only a before-1984 date and a National Archives of Tunisia attribution; no archive identifier or original publication record is supplied.',
    scene: [453, 640],
    panel: [905, 1280],
    alt: 'Adults and children gather at the entrance of a cave used as shelter during the Algerian War.',
    caption: 'People shelter at a cave entrance in a photograph whose filename says Algerian refugees in 1958; Commons itself records only “before 1984.”',
    historicalNote: 'This is war-context evidence, not a scene from Fanon’s writing and not proof of a particular family’s experience. A Wikipedian in Residence at the National Archives of Tunisia supplied the media file, but Commons gives no archive identifier, original publication, or direct repository rights record. Commons extracted this version from a larger scan with a recorded crop of about 36 percent horizontally and 32 percent vertically; Philosophy Atlas applies no further crop.',
    focalPoint: {x: .5, y: .47},
  }),
  asset({
  ...
  asset({
    ...
    creator: 'Unknown photographer',
    objectDate: '1905–1940 archive coverage range; exact date unknown',
    institution: 'Church of Scotland Slide and Visual Collection, CSWC 47, University of Edinburgh Library Heritage Collections; legacy USC digitization impa-m68737',
    ...
    objectPageUrl: 'https://archives.collections.ed.ac.uk/repositories/2/resources/87170',
    rights: {license: 'Repository use conditions require contact. Commons applies a Public Domain Mark, but its pre-1931 U.S. rationale is unverified across the 1905–1940 coverage range', licenseUrl: 'https://library.ed.ac.uk/digitisation-services/cultural-heritage-digitisation-service/image-licensing', rightsKind: 'rights-status'},
    attribution: 'Unknown photographer, primary-school class at the Church of Scotland Kikuyu mission in Kenya, 1905–1940 archive coverage range, file GB 237 CSWC47/LS7/24. The Foreign Mission Committee is the fonds creator, not an identified photographer.',
    scene: [640, 640],
    panel: [1279, 1280],
    alt: 'Young women and men gather in a crowded classroom at the Church of Scotland Kikuyu mission in Kenya.',
    caption: 'An undated primary-school class at the Church of Scotland Kikuyu mission within a 1905–1940 archive range; language, lesson, and individual identities are unrecorded.',
    historicalNote: 'The lantern slide belongs to the Church of Scotland Slide and Visual Collection, now held by the University of Edinburgh; a legacy USC record supplied the digitization. The image is not Ngũgĩ wa Thiong’o’s classroom or Kamĩrĩĩthũ and does not establish the language of instruction. The repository requires contact for use details, while the Commons public-domain rationale assumes publication before 1931 that the broad date range does not prove.',
    focalPoint: {x: .5, y: .48},
  }),
  asset({
