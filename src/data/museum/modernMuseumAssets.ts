...
export const MODERNITY_MUSEUM_ASSETS = [
  ...
  modernAsset({
    ...
    title: 'Levi Eshkol welcoming Simone de Beauvoir in Tel Aviv', creator: 'Fritz Cohen', objectDate: '29 March 1967', institution: 'Israel Government Press Office, D804-102',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Simone_de_Beauvoir_1967_(cropped).jpg', ...publicDomain,
    attribution: 'Fritz Cohen, Prime Minister Levi Eshkol welcoming Simone de Beauvoir at his HaKirya office in Tel Aviv, 29 March 1967. Israel Government Press Office, D804-102; public-domain status recorded for the photograph.', derivativeNotice,
    scene: [504, 640], panel: [735, 934], alt: 'Cropped black-and-white press photograph of Simone de Beauvoir smiling while shaking hands with Israeli prime minister Levi Eshkol in his Tel Aviv office.',
    caption: 'Levi Eshkol welcomes Simone de Beauvoir at his HaKirya office in Tel Aviv, 29 March 1967.', historicalNote: 'A cropped lifetime press photograph of a diplomatic welcome, not a lecture, feminist meeting, or evidence for Beauvoir’s ethical argument. The uncropped source identifies the institutional setting and both participants.', likenessStatus: 'lifetime-photograph', focalPoint: {x: .5, y: .4},
  }),
  modernAsset({
    id: 'beauvoir-suffrage-poster-1924', hallFolder: 'modernity-freedom-critique', entityId: 'beauvoir', role: 'context', mediaKind: 'document',
    title: 'French women’s suffrage poster', creator: 'Union française pour le suffrage des femmes', objectDate: '1924', institution: 'Archives nationales, France, F/7/13266',
    ...
    attribution: 'Union française pour le suffrage des femmes, suffrage poster, 1924. Archives nationales, France, F/7/13266, CC0.', derivativeNotice,
