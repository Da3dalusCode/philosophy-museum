...
import type {MuseumExhibitId} from '../museumCatalog';
...
const interpretations = {
  socrates: {
    id: 'socrates', kind: 'philosopher', name: 'Socrates', originalName: 'Σωκράτης', dateLabel: '469–399 BCE', entityType: 'Athenian philosopher',
    ...
    relatedExhibitId: 'plato', articleRoute: {kind: 'philosopher', philosopherId: 'socrates'},
  },
  plato: {
    id: 'plato', kind: 'philosopher', name: 'Plato', originalName: 'Πλάτων', dateLabel: 'c. 429/427–347 BCE', entityType: 'Athenian philosopher and dialogue author',
    ...
    relatedExhibitId: 'aristotle', articleRoute: {kind: 'philosopher', philosopherId: 'plato'},
  },
  aristotle: {
    id: 'aristotle', kind: 'philosopher', name: 'Aristotle', originalName: 'Ἀριστοτέλης', dateLabel: '384–322 BCE', entityType: 'Greek philosopher and research organizer',
    ...
    relatedExhibitId: 'epicureanism', articleRoute: {kind: 'philosopher', philosopherId: 'aristotle'},
  },
  cynicism: {
    id: 'cynicism', kind: 'tradition', name: 'Cynicism', dateLabel: 'Late 5th century BCE–Late Antiquity', entityType: 'Philosophical movement and way of life',
    ...
    relatedExhibitId: 'stoicism', articleRoute: {kind: 'branch', branchId: 'cynicism'},
  },
  epicureanism: {
    id: 'epicureanism', kind: 'tradition', name: 'Epicureanism', dateLabel: 'Founded c. 307/306 BCE', entityType: 'Hellenistic philosophical school',
    ...
    relatedExhibitId: 'stoicism', articleRoute: {kind: 'branch', branchId: 'epicureanism'},
  },
  stoicism: {
    id: 'stoicism', kind: 'tradition', name: 'Stoicism', dateLabel: 'Founded c. 300 BCE', entityType: 'Hellenistic and Roman philosophical system',
    ...
    relatedExhibitId: 'skepticism', articleRoute: {kind: 'branch', branchId: 'stoicism'},
  },
  skepticism: {
    id: 'skepticism', kind: 'tradition', name: 'Ancient Skepticism', dateLabel: '3rd century BCE–c. 3rd century CE', entityType: 'Academic and Pyrrhonian movements',
    ...
    relatedExhibitId: 'neoplatonism', articleRoute: {kind: 'branch', branchId: 'skepticism'},
  },
  neoplatonism: {
    id: 'neoplatonism', kind: 'tradition', name: 'Neoplatonism', dateLabel: '3rd–6th centuries CE', entityType: 'Late-antique Platonic tradition',
    ...
    relatedExhibitId: 'plato', articleRoute: {kind: 'branch', branchId: 'neoplatonism'},
  },
...
export const getMuseumInterpretation = (id: MuseumExhibitId): MuseumInterpretation => interpretations[id];
