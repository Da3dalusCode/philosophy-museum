...
import {MEDITERRANEAN_EARLY_PRIMARY_INTERPRETATIONS} from './mediterraneanEarlyPrimaryInterpretations';
import {MEDITERRANEAN_LATER_PRIMARY_INTERPRETATIONS} from './mediterraneanLaterPrimaryInterpretations';
...
import {ARTICLE_CLAIM_REVIEW_BATCH_PHILOSOPHER_EXHIBIT_EDITORIAL} from './articleClaimReviewBatchPhilosopherExhibitEditorial';
...
const ANCIENT_MUSEUM_INTERPRETATIONS = {
  ...
  cynicism: {
    hallId: 'ancient-greek', id: 'cynicism', kind: 'tradition', name: 'Cynicism', dateLabel: 'Recognizable movement from the 4th century BCE–Late Antiquity', entityType: 'Philosophical movement and way of life',
    ...
    tradition: {
      origin: 'Fourth-century BCE Socratic circles; Antisthenes’ founder status and the reported succession to Diogenes remain contested', place: 'Athens and the wider Greek world', historicalPeriod: 'Classical Greece through Late Antiquity',
...
Readonly<Record<string, MuseumPrimaryInterpretationEnrichment>> = {
  ...
  ...MEDITERRANEAN_EARLY_PRIMARY_INTERPRETATIONS,
  ...MEDITERRANEAN_LATER_PRIMARY_INTERPRETATIONS,
  ...
  ...ARTICLE_CLAIM_REVIEW_BATCH_PHILOSOPHER_EXHIBIT_EDITORIAL,
