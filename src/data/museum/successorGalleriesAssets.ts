...
export const SUCCESSOR_GALLERIES_ASSETS = [
  ...
  asset({
    ...
    alt: 'Two facing profile medallions are labeled Arcesilaus and Carneades.', caption: 'Arcesilaus and Carneades paired in an 1810 Academica title page.', historicalNote: 'The paired profiles are retrospective inventions. Their value is reception and lineage, not physiognomic evidence.', likenessStatus: 'imagined',
  }),
  asset({
    id: 'carneades-louvre-bust', folder: 'hellenistic-roman-ways', entityKind: 'philosopher', entityId: 'carneades', role: 'identity', mediaKind: 'sculpture-photograph',
    title: 'Bust identified as Carneades', creator: 'Unknown Roman sculptor', objectDate: 'Roman copy after a Hellenistic portrait', imageCreator: 'Marie-Lan Nguyen', institution: 'Musée du Louvre, Ma 72', sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Carneades_Campana_Louvre_Ma72.jpg', ...publicDomain, derivativeNotice,
    attribution: 'Louvre Ma 72, photograph by Marie-Lan Nguyen. Public domain.', scene: [427, 640], panel: [853, 1280],
    alt: 'Marble bust of an elderly philosopher with a high forehead and thick beard.', caption: 'Roman bust identified as Carneades. Louvre Ma 72.', historicalNote: 'The ancient object is a later copy, and the identification should be treated as attributed rather than certain.', likenessStatus: 'attributed', focalPoint: {x: .5, y: .4},
  }),
  asset({
