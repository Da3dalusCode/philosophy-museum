...
export const PHENOMENOLOGY_GALLERY_ASSETS = [
  ...
  galleryAsset({
    ...
    title: 'Jean-Paul Sartre as a student at the École normale supérieure', creator: 'Unknown photographer', objectDate: 'c. 1924', institution: 'École normale supérieure, photographic collection',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Jean-Paul_Sartre_1924.jpg', ...cc0,
    attribution: 'Unknown photographer, Jean-Paul Sartre as an École normale supérieure student, c. 1924. École normale supérieure photographic collection, CC0.', derivativeNotice,
