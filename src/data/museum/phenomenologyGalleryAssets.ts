...
export const PHENOMENOLOGY_GALLERY_ASSETS = [
  ...
  galleryAsset({
    ...
    title: 'Intentionality: object, profile, and horizon', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum',
    ...
    attribution: 'Philosophy Atlas Museum interpretive image; prompt, model, version, generation date, and raw original output unknown.', derivativeNotice: originalNotice,
  ...
  galleryAsset({
    ...
    title: 'Equipment, breakdown, and being-in-the-world', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum',
  ...
  galleryAsset({
    ...
    title: 'The body opens a field of perception', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum',
  ...
  galleryAsset({
    ...
    title: 'Situated freedom at a threshold', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum',
  ...
  galleryAsset({
    ...
    title: 'Role, performance, and the look', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum',
  ...
  galleryAsset({
    id: 'levinas-ethical-interruption-interpretive', entityKind: 'philosopher', entityId: 'levinas', role: 'context', mediaKind: 'digital-image',
    title: 'Interrupted Passage: a contemporary face-to-face interpretation', creator: 'Philosophy Atlas Museum; generation details unavailable', objectDate: 'Generation date unknown', institution: 'Philosophy Atlas Museum repository',
    sourcePageUrl: 'https://github.com/Da3dalusCode/philosophy-museum/blob/4e8587112422ca01c2a3b70b02bcd4e356f529b0/source-art/museum/levinas-face-to-face-contemporary-interpretation.png',
    license: 'Repository-held interpretive image; original generation lineage incomplete', rightsKind: 'rights-status',
    attribution: 'Philosophy Atlas Museum, Interrupted Passage. Generation prompt, model, version, date, and raw original output are unknown.', derivativeNotice,
    scene: [640, 480], panel: [1280, 960], alt: 'Contemporary interpretive scene of a passerby stopping before an exhausted stranger outside a clinic after rain.',
    caption: 'Interrupted Passage, a contemporary interpretation of ethical interruption; not historical evidence about Levinas.',
    historicalNote: 'This is a contemporary interpretive image, not a historical reconstruction, documentary photograph, or portrait of Levinas. A durable repository source-art file survives, but available evidence does not recover the generation prompt, model, version, date, raw original output, or raw-output hash.', likenessStatus: 'not-applicable', focalPoint: {x: .5, y: .5},
  }),
  galleryAsset({
