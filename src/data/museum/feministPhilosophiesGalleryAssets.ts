...
export const FEMINIST_PHILOSOPHIES_GALLERY_ASSETS = [
  ...
  asset({
    ...
    objectPageUrl: 'https://nihrecord.nih.gov/sites/recordNIH/files/pdf/1990/NIH-Record-1990-05-29.pdf',
  ...
  asset({
    ...
    objectDate: '29 September 2019', institution: 'No holding institution; creator-uploaded through Wikimedia Commons',
    ...
    caption: 'Avery Jensen’s creator-licensed photograph of the National Trans Visibility March, 29 September 2019.',
