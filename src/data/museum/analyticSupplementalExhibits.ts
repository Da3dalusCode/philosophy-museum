...
import {reviewAnalyticSupplementalExhibit} from './gallery20And21SupplementalReview';
import type {
...
export const ANALYTIC_SUPPLEMENTAL_EXHIBITS = ([
  ...
  analyticExhibit({
    id: 'wittgenstein-tractatus-opening',
    displayName: 'Wittgenstein: Tractatus Logico-Philosophicus — World and Facts',
    shortTitle: 'Tractatus: World and Facts',
    workLabel: 'TRACTATUS LOGICO-PHILOSOPHICUS · OPENING PROPOSITIONS',
    dateLabel: 'German publication 1921 · English edition 1922',
    question: 'Why does the Tractatus begin with facts rather than a catalogue of things?',
    frontSubtitle: 'World, facts, states of affairs, numbered architecture, representation, and limits',
    lead: 'The opening page lets visitors encounter the Tractatus as a deliberately constructed work rather than only as a set of doctrines. Its nested numbers present propositions as comments and elaborations within a larger architecture. The first movement—from “the world is all that is the case” to the world as a totality of facts—shifts attention away from isolated objects toward objects arranged in obtaining states of affairs. This structure prepares the book’s account of how propositions picture possibilities.',
    keyIdeas: [
      'The world is characterized as the totality of facts, not the totality of independently listed things.',
      'Objects matter through possible combinations; an obtaining combination is a state of affairs.',
      'The decimal numbering makes the order of exposition visible but does not by itself settle how every remark logically depends on another.',
    ],
    cautions: [
      'The first propositions should be read within the whole book, including its disputed remarks on ethics, value, and silence.',
      'The 1922 parallel text is an early English translation, not an unmediated transcription of Wittgenstein’s German.',
      'Later Wittgenstein rejects the search for one crystalline logical form as a complete philosophical method.',
    ],
    sections: [
      {heading: 'A world articulated by facts', paragraphs: ['A mere inventory of objects would not distinguish one possible world from another. Facts tell us which combinations obtain. Propositions can then represent possible combinations and be true or false according to whether reality agrees with them.']},
      {heading: 'Architecture on the page', paragraphs: ['The main integers and decimal remarks give the work a visible hierarchy. The device invites readers to reconstruct an argument, while interpretive disputes remain about whether the book offers doctrine, clarification, a self-cancelling ladder, or some combination.']},
      {heading: 'A companion across the room', paragraphs: ['The title-page exhibit introduces the work and its publication history; this opening page supplies direct textual evidence. Investigations and Language Games then show how Wittgenstein’s later method relocates philosophical attention from ideal representation toward use and practice.']},
    ],
    sources: [
      {label: 'Wittgenstein, Tractatus Logico-Philosophicus (Project Gutenberg)', url: 'https://www.gutenberg.org/ebooks/5740', kind: 'primary-text'},
      {label: 'Wikimedia Commons — first page of the 1922 Harcourt edition', url: 'https://commons.wikimedia.org/wiki/File:Tractatus_first_page_1922_Harcourt.png', kind: 'collection-record'},
      {label: 'Stanford Encyclopedia of Philosophy — Ludwig Wittgenstein', url: 'https://plato.stanford.edu/entries/wittgenstein/', kind: 'academic-reference'},
    ],
    assetId: 'wittgenstein-tractatus-first-page-1922',
    panelAssetId: 'wittgenstein-tractatus-first-page-1922',
    articleRoute: {kind: 'philosopher', philosopherId: 'wittgenstein'},
    presentation: presentation('Gallery 20 supplemental work exhibit', 'The world is the totality of facts', [
      {label: 'Philosopher', value: 'Ludwig Wittgenstein'},
      {label: 'Work', value: 'Tractatus Logico-Philosophicus'},
      {label: 'Visual', value: 'Opening page of the 1922 English edition'},
      {label: 'Atlas route', value: 'Wittgenstein’s full profile'},
    ], 'Open Wittgenstein’s full Atlas article'),
  }),
  analyticExhibit({
...
] as const satisfies readonly MuseumSupplementalExhibit[]).map(reviewAnalyticSupplementalExhibit);

export const ANALYTIC_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  layout({id: 'frege-sense-reference', parentExhibitId: 'frege', zoneId: 'analytic-origins-foundations', position: {x: -5.55, z: -17.42}, rotationY: Math.PI, assetId: 'frege-sense-reference-1892', mediaWidth: 3.2, mediaHeight: 3.2 * 478 / 640, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.prussian}),
  layout({id: 'russell-whitehead-principia', parentExhibitId: 'russell', zoneId: 'analytic-origins-foundations', position: {x: 5.55, z: -27.38}, rotationY: 0, assetId: 'russell-whitehead-principia-1910', mediaWidth: 3.2, mediaHeight: 3.2 * 469 / 640, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'russell-logical-types', parentExhibitId: 'russell', zoneId: 'analytic-origins-foundations', position: {x: 5.55, z: -17.42}, rotationY: Math.PI, assetId: 'russell-principia-54-43', mediaWidth: 3.2 * 447 / 640, mediaHeight: 3.2, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.copper}),
  layout({id: 'moore-principia-ethica', parentExhibitId: 'g-e-moore', zoneId: 'analytic-common-sense-metaethics', position: {x: -5.55, z: -16.18}, rotationY: 0, assetId: 'moore-principia-ethica-1903', mediaWidth: 3.2 * 392 / 640, mediaHeight: 3.2, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'moore-open-question', parentExhibitId: 'g-e-moore', zoneId: 'analytic-common-sense-metaethics', position: {x: -5.55, z: -6.22}, rotationY: Math.PI, assetId: 'moore-open-question-interpretive', mediaWidth: 3.2 * 409 / 640, mediaHeight: 3.2, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.vermilion}),
  ...
  layout({id: 'moore-external-world', parentExhibitId: 'g-e-moore', zoneId: 'analytic-common-sense-metaethics', position: {x: 10.85, z: -11.2}, rotationY: -Math.PI / 2, assetId: 'moore-external-world-hands', mediaWidth: 3.2 * 557 / 640, mediaHeight: 3.2, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.copper}),
  layout({id: 'moore-cambridge-practice', parentExhibitId: 'g-e-moore', zoneId: 'analytic-common-sense-metaethics', position: {x: 5.55, z: -6.22}, rotationY: Math.PI, assetId: 'moore-moral-sciences-club-1913', mediaWidth: 3.2, mediaHeight: 3.2 * 269 / 410, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'wittgenstein-tractatus', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: -10.85, z: 0}, rotationY: Math.PI / 2, assetId: 'wittgenstein-tractatus-1922', mediaWidth: 3.2 * 442 / 640, mediaHeight: 3.2, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.prussian, width: 4}),
  layout({id: 'wittgenstein-tractatus-opening', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: 10.85, z: 0}, rotationY: -Math.PI / 2, assetId: 'wittgenstein-tractatus-first-page-1922', mediaWidth: 3.2 * 442 / 640, mediaHeight: 3.2, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.prussian, width: 4}),
  layout({id: 'wittgenstein-truth-tables', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: -5.55, z: 4.98}, rotationY: Math.PI, assetId: 'wittgenstein-truth-table-schema', mediaWidth: 3.2, mediaHeight: 3.2 * 252 / 639, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.copper}),
  layout({id: 'wittgenstein-investigations', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: 5.55, z: -4.98}, rotationY: 0, assetId: 'anscombe-philosophical-investigations-1953', mediaWidth: 3.2, mediaHeight: 3.2 * 400 / 640, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'wittgenstein-language-games', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: 5.55, z: 4.98}, rotationY: Math.PI, assetId: 'wittgenstein-language-games-interpretive', mediaWidth: 3.2 * 409 / 640, mediaHeight: 3.2, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.vermilion}),
  ...
  layout({id: 'quine-ontology', parentExhibitId: 'quine', zoneId: 'analytic-naturalism', position: {x: -5.55, z: 16.18}, rotationY: Math.PI, assetId: 'quine-porphyrian-tree', mediaWidth: 3.2 * 483 / 640, mediaHeight: 3.2, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.copper}),
  layout({id: 'quine-word-object', parentExhibitId: 'quine', zoneId: 'analytic-naturalism', position: {x: 5.55, z: 6.22}, rotationY: 0, assetId: 'quine-young-hare', mediaWidth: 3.2 * 579 / 640, mediaHeight: 3.2, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.paper}),
  layout({id: 'quine-naturalized-epistemology', parentExhibitId: 'quine', zoneId: 'analytic-naturalism', position: {x: 10.85, z: 11.2}, rotationY: -Math.PI / 2, assetId: 'quine-experimental-psychology-lab', mediaWidth: 3.2, mediaHeight: 3.2 * 462 / 640, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.ink}),
  ...
  layout({id: 'anscombe-intention-why', parentExhibitId: 'anscombe', zoneId: 'analytic-action-intention', position: {x: -5.55, z: 17.42}, rotationY: 0, assetId: 'anscombe-intention-interpretive', mediaWidth: 3.2 * 409 / 640, mediaHeight: 3.2, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.vermilion}),
  layout({id: 'anscombe-practical-knowledge', parentExhibitId: 'anscombe', zoneId: 'analytic-action-intention', position: {x: -5.55, z: 27.38}, rotationY: Math.PI, assetId: 'anscombe-hand-water-pump', mediaWidth: 3.2, mediaHeight: 3.2 * 497 / 640, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.copper}),
  layout({id: 'anscombe-modern-moral-philosophy', parentExhibitId: 'anscombe', zoneId: 'analytic-action-intention', position: {x: 5.55, z: 17.42}, rotationY: 0, assetId: 'anscombe-seven-virtues', mediaWidth: 3.2, mediaHeight: 3.2 * 182 / 640, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.prussian}),
  layout({id: 'anscombe-truman-degree', parentExhibitId: 'anscombe', zoneId: 'analytic-action-intention', position: {x: 10.85, z: 22.4}, rotationY: -Math.PI / 2, assetId: 'anscombe-truman-portrait', mediaWidth: 3.2, mediaHeight: 3.2 * 441 / 550, installationKind: 'analytic-context', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'anscombe-causality', parentExhibitId: 'anscombe', zoneId: 'analytic-action-intention', position: {x: 5.55, z: 27.38}, rotationY: Math.PI, assetId: 'anscombe-newtons-cradle', mediaWidth: 3.2, mediaHeight: 3.2 * 570 / 640, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.copper}),
