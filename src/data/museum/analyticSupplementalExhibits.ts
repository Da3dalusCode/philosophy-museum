...
export const ANALYTIC_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  ...
  layout({id: 'russell-whitehead-principia', parentExhibitId: 'russell', zoneId: 'analytic-origins-foundations', position: {x: 5.55, z: -27.38}, rotationY: 0, assetId: 'russell-whitehead-principia-1910', mediaWidth: 3.46, mediaHeight: 2.54, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.ink}),
  layout({id: 'russell-logical-types', parentExhibitId: 'russell', zoneId: 'analytic-origins-foundations', position: {x: 5.55, z: -17.42}, rotationY: Math.PI, assetId: 'russell-principia-54-43', mediaWidth: 2.24, mediaHeight: 3.2, installationKind: 'analytic-concept', accent: ANALYTIC_PALETTE.copper}),
  ...
  layout({id: 'wittgenstein-tractatus-opening', parentExhibitId: 'wittgenstein', zoneId: 'analytic-wittgenstein', position: {x: 10.85, z: 0}, rotationY: -Math.PI / 2, assetId: 'wittgenstein-tractatus-first-page-1922', mediaWidth: 2.2, mediaHeight: 3.2, installationKind: 'analytic-work', accent: ANALYTIC_PALETTE.prussian, width: 4}),
