...
export const UTILITY_LIBERTY_CAPITAL_SUPPLEMENTAL_EXHIBITS = [
  ...
  curated({
    ...
    sectionDetails: [
      ...
      'Harriet Taylor and John Stuart Mill met in 1830 and sustained an intellectual relationship across the following decades. Her first husband, John Taylor, died in 1849; she and Mill married in 1851. Current scholarship generally treats “The Enfranchisement of Women” as primarily hers while retaining disputes about collaboration and exact attribution, especially for On Liberty.',
    ...
    cautions: ['The artist is unknown, but the National Portrait Gallery dates the portrait c. 1834; do not turn that approximate date into a sitting date or evidence of intellectual activity.', 'Avoid both reducing Taylor Mill to influence and claiming unsupported coauthorship of every Mill text.'],
