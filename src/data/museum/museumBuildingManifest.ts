...
export type MuseumManifestNode = {
  ...
  /** Curated content id; absent from the six planned/walkable shells. */
...
const assertApprovedManifest = (candidate: MuseumBuildingManifest): void => {
  ...
  ) throw new Error('The Continuous Enfilade must expose 26 halls, 105 rooms, 20 curated galleries, 6 planned shells, and two reserves.');
