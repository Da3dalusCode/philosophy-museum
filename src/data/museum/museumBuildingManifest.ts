...
export type MuseumManifestNode = {
  ...
  /** Curated content id; absent from planned/walkable shells. */
...
const assertApprovedManifest = (candidate: MuseumBuildingManifest): void => {
  ...
  ) throw new Error('The Continuous Enfilade must expose 26 halls, 105 rooms, 22 curated galleries, 4 planned shells, and two reserves.');
