...
Readonly<Record<string, MuseumPrimaryInterpretationEnrichment>> = {
  ...
  'ibn-tufayl': {
    lead: 'Ibn Tufayl turns philosophical education into narrative experiment. Hayy ibn Yaqzan follows an exceptional island-dweller from embodied observation through causal reasoning and contemplation, then tests what solitary insight can do when it meets language, religion, and society. Its unsettled ending makes pedagogy part of the philosophical problem.',
    keyIdeas: [],
    keyWorks: [],
    sections: [{heading: '', paragraphs: [
      'The tale is a designed experiment, not a report of real child development or a transparent statement of every belief held by its author. The narrator, Hayy, Absal, and Salaman have literary roles. Hayy’s investigation of the gazelle joins grief, anatomy, and the question of life; later stages compress a learned philosophical curriculum. Observation, demonstration, disciplined practice, and contemplative experience disclose related truths without becoming one method.',
      'Contact with Absal and society makes communication the decisive test. A community already lives through language, ritual, authority, work, and unequal opportunities for study. Hayy’s failure may expose his audience, but it also exposes the teacher’s inability to translate insight into shared forms. The ending is neither reason defeating revelation nor simple anti-social individualism. It asks what can be taught responsibly, to whom, and through which images and practices.',
      'Reception should name documented routes. Hayy circulated in Hebrew and received Moses Narboni’s commentary in 1349; a Latin translation appeared in 1671 and Ockley’s English version in 1708. Similarities to Locke, Defoe, or later fiction do not prove direct borrowing. A later report associates Ibn Tufayl with presenting Ibn Rushd at court, but it does not establish discipleship. Both cautions preserve real connections without converting availability into causation.',
      'The later illustration on this wall belongs to that reception history. It makes solitary study visible, but the narrative’s intellectual movement never remains purely solitary: books are absent from Hayy’s island, yet the work itself presupposes philosophical and religious traditions, and its ending turns from discovery toward the ethics and limits of teaching.',
    ]}],
    presentation:{mode:'concise',orientation:[
      {label:'Historical setting',value:'Al-Andalus and Almohad Morocco · c. 1105–1185/86'},
      {label:'Form',value:'Philosophical narrative · staged education · literary roles'},
      {label:'Inquiry',value:'Body · observation · cause · demonstration · contemplation'},
      {label:'Public problem',value:'Language · prophecy · ritual · pedagogy · failed mission'},
      {label:'Documented reception',value:'Hebrew · Narboni 1349 · Latin 1671 · English 1708'},
      {label:'Interpretive caution',value:'Not a natural-child report · no unproved discipleship or borrowing'},
    ],articleActionLabel:'Read the full sourced Ibn Tufayl article',bodyLayout:'prose',plaqueKicker:'',plaqueSubtitleLines:4},
    objectInterpretations:objectInterpretation('ibn-tufayl-hayy-1929','This 1929 illustration visualizes a twentieth-century reception of Hayy ibn Yaqzan, not Ibn Tufayl’s appearance or a documentary island scene. Its solitary learner can invite the very simplification the story complicates: Hayy’s development is deliberately constructed and its final test is social communication.'),
    sources:[{label:'Hayy ibn Yaqzan — complete Ockley translation',url:'https://www.gutenberg.org/cache/epub/16831/pg16831-images.html',kind:'primary-text'},{label:'Oxford Handbook — Ibn Tufayl’s Hayy ibn Yaqzan',url:'https://academic.oup.com/edited-volume/38657/chapter-abstract/335768370',kind:'academic-reference'}],
  },
  suhrawardi: {
