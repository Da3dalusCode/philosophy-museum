...
import {reviewEnlightenmentSupplementalExhibit} from './enlightenmentSupplementalReview';
...
].map(reviewEnlightenmentSupplementalExhibit) as readonly MuseumSupplementalExhibit[];
