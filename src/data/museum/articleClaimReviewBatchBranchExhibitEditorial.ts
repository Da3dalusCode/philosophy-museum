...
const EXHIBIT_REVIEW_LOCKS_BY_NAME: Readonly<Record<string, `fnv1a64:${string}`>> = {
  ...
  Metaphysics: 'fnv1a64:01432a864800e1d0',
  Epistemology: 'fnv1a64:133ce7924fb58de2',
...
Readonly<Record<string, BranchExhibitEditorialRecord>> = {
  ...
  metaphysics: {
    ...
    principalAsset: {
      ...
      provenance: 'Original 2026 interpretive illustration created by Philosophy Atlas Museum with OpenAI ImageGen; held by Philosophy Atlas Museum with the registered repository source path.',
    ...
    interpretation: objectLed(
      ...
      'This 2026 Philosophy Atlas Museum illustration layers ordinary objects, structures, processes, and cosmic scale as a conceptual prompt. It does not establish one hierarchy of reality, choose a fundamental level, or show that every tradition practices metaphysics through the same categories.',
      [
  ...
  epistemology: {
    ...
    interpretation: objectLed(
      ...
      'This 2026 Philosophy Atlas Museum illustration stages perception, testimony, observation, and inference through a fallible instrument. It is an interpretive prompt, not a proof that knowledge is sensory data, a settled model of justification, or a neutral view from outside institutions and power.',
      [
