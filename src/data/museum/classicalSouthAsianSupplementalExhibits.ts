...
export const CLASSICAL_SOUTH_ASIAN_SUPPLEMENTAL_EXHIBIT_LAYOUTS = [
  ...
  layout({id: 'nyaya-spitzer-philosophy-fragments', parentExhibitId: 'kanada', zoneId: 'south-categories-realism', position: {x: 5.55, z: -4.48}, rotationY: 0, assetId: 'nyaya-spitzer-sht810-interpretive', mediaWidth: 3.52, mediaHeight: 1.98, installationKind: 'south-asian-work', accent: CLASSICAL_SOUTH_ASIAN_PALETTE.verdigris}),
