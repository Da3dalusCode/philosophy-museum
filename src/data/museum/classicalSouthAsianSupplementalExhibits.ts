...
const exhibits = [
  ...
  },
  {
    ...
    keyIdeas: ['The Yoga Sūtras organize practice, affliction, concentration, cognition, and liberation.', 'Aphoristic text and commentary are historically intertwined.', 'The proposed floruit from roughly the 2nd century BCE to 4th century CE is an authorship range, not a lifespan.'],
    ...
    sections: [
      ...
      {heading: 'Chronology remains a range', paragraphs: ['The broad authorship window records scholarly uncertainty. It should never be displayed as though one person lived continuously across those centuries. The gallery therefore labels a tradition and attributed text before it pretends to narrate a secure biography.']},
    ],
    sources: [
