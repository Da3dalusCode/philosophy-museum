...
export const MUSEUM_ASSETS = [
  {
    ...
    license: 'CC BY-SA 2.5', licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.5/', attribution: 'Eric Gaba (Wikimedia Commons user Sting), CC BY-SA 2.5.',
  ...
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Jacques-Louis David, The Death of Socrates, The Metropolitan Museum of Art. Public domain.',
  ...
  },
  {
    ...
    license: 'CC BY 2.5', licenseUrl: 'https://creativecommons.org/licenses/by/2.5/', attribution: '© Marie-Lan Nguyen / Wikimedia Commons / CC BY 2.5.',
    ...
    historicalNote: 'This is a Roman copy of a posthumous and idealized Greek portrait, not a contemporary likeness.', likenessStatus: 'roman-copy', focalPoint: {x: .5, y: .38},
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Raphael, The School of Athens, Vatican Museums. Public domain.',
  ...
  },
  {
    ...
    license: 'Public-domain dedication (PD-self)', licenseUrl: 'https://commons.wikimedia.org/wiki/Template:PD-self', attribution: 'Jastrow, Bust of Aristotle, public-domain dedication.',
  ...
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'British Library, Papyrus 131. Public domain.',
  ...
  },
  {
    ...
    license: 'CC0 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/', attribution: 'Jean-Léon Gérôme, Diogenes, Walters Art Museum, CC0.',
  ...
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Gaspar de Crayer, Alexander and Diogenes, Wallraf–Richartz Museum. Public domain.',
  ...
  },
  {
    ...
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Lucretius,_De_rerum_natura.jpg',
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Vatican Library, Vat. lat. 1569, fol. 1r. Public domain.',
  ...
  },
  {
    ...
    license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0/', attribution: 'Jeremy Weate, CC BY 2.0.',
  ...
  },
  {
    ...
    title: 'Portrait bust of Marcus Aurelius', creator: 'Unknown Roman sculptor', objectDate: 'Antonine period, 161–180 CE', imageCreator: 'Wikimedia Commons user Steerpike', institution: 'Photographed at The Metropolitan Museum of Art',
    sourcePageUrl: 'https://commons.wikimedia.org/wiki/File:Marcus_Aurelius_Metropolitan_Museum.png',
    license: 'Public-domain dedication (PD-self)', licenseUrl: 'https://commons.wikimedia.org/wiki/Template:PD-self', attribution: 'Steerpike, public-domain dedication.',
    ...
    caption: 'Antonine portrait bust of Marcus Aurelius, 161–180 CE; photographed at The Met.',
    historicalNote: 'The Commons page lacks an accession number and describes the work as a Louvre loan; ownership and current location should therefore remain qualified.', likenessStatus: 'not-applicable', focalPoint: {x: .5, y: .42},
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Gottlieb Friedrich Riedel, Sextus Empyricus, 1801. Public domain.',
  ...
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Bibliothèque nationale de France / Gallica. Public domain.',
  ...
  },
  {
    ...
    license: 'CC BY 3.0', licenseUrl: 'https://creativecommons.org/licenses/by/3.0/', attribution: 'Sailko, CC BY 3.0.',
  ...
  },
  {
    ...
    license: 'Public Domain Mark 1.0', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', attribution: 'Bibliothèque nationale de France, Grec 1816. Public domain.',
