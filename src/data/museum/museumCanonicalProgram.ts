    ...
    rooms: [
      {
        ...
        exhibits: [
          ...
          exhibit({id: 'thales', entityKind: 'philosopher', entityId: 'thales', displayName: 'Thales', tier: 'standard-individual-exhibit', question: 'Could the changing world be explained through nature itself?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'thales-miletus-theatre'}),
          ...
          exhibit({id: 'anaximenes', entityKind: 'philosopher', entityId: 'anaximenes', displayName: 'Anaximenes', tier: 'supporting-exhibit', question: 'How could air become many different kinds of thing?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'anaximenes-miletus-site'}),
        ],
      },
      {
        ...
        exhibits: [
          ...
          exhibit({id: 'philolaus', entityKind: 'philosopher', entityId: 'philolaus', displayName: 'Philolaus', tier: 'supporting-exhibit', question: 'How do limit and unlimited combine into an intelligible order?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'philolaus-lyre-lekythos'}),
          exhibit({id: 'parmenides', entityKind: 'philosopher', entityId: 'parmenides', displayName: 'Parmenides', tier: 'standard-individual-exhibit', question: 'What can thought consistently say about being and change?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'parmenides-porta-rosa'}),
          exhibit({id: 'zeno-elea', entityKind: 'philosopher', entityId: 'zeno-elea', displayName: 'Zeno of Elea', tier: 'standard-individual-exhibit', question: 'What do paradoxes reveal about motion, plurality, and reasoning?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'zeno-velia-theatre'}),
          exhibit({id: 'leucippus', entityKind: 'philosopher', entityId: 'leucippus', displayName: 'Leucippus', tier: 'gallery-archive-or-study-wall-record', question: 'Can change be explained through indivisible bodies moving in void?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'leucippus-lucretius-manuscript'}),
          exhibit({id: 'democritus', entityKind: 'philosopher', entityId: 'democritus', displayName: 'Democritus', tier: 'standard-individual-exhibit', question: 'How far can atomism explain nature, perception, and human flourishing?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'democritus-abdera-site'}),
          exhibit({id: 'heraclitus', entityKind: 'philosopher', entityId: 'heraclitus', displayName: 'Heraclitus', tier: 'standard-individual-exhibit', question: 'How can conflict and transformation belong to an intelligible order?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'heraclitus-ephesus-artemision'}),
          exhibit({id: 'empedocles', entityKind: 'philosopher', entityId: 'empedocles', displayName: 'Empedocles', tier: 'standard-individual-exhibit', question: 'Can stable elements and opposing forces account for cosmic change?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'empedocles-akragas-temple'}),
          exhibit({id: 'anaxagoras', entityKind: 'philosopher', entityId: 'anaxagoras', displayName: 'Anaxagoras', tier: 'standard-individual-exhibit', question: 'What role could mind play in ordering an indefinitely mixed cosmos?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'anaxagoras-klazomenai-sarcophagus'}),
        ],
      },
      {
        ...
        recordCapacity: 4,
        exhibits: [
          exhibit({id: 'protagoras', entityKind: 'philosopher', entityId: 'protagoras', displayName: 'Protagoras', tier: 'standard-individual-exhibit', question: 'How do judgment, education, and civic argument depend on human measure?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'protagoras-pnyx'}),
          exhibit({id: 'gorgias', entityKind: 'philosopher', entityId: 'gorgias', displayName: 'Gorgias', tier: 'standard-individual-exhibit', question: 'What can speech accomplish when truth and persuasion come apart?', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'gorgias-leontinoi-tetradrachm'}),
      ...
      },
      {
        ...
        recordCapacity: 5,
        exhibits: [
          exhibit({id: 'platonism', entityKind: 'branch', entityId: 'platonism', displayName: 'Platonism', tier: 'anchor-exhibit', question: 'How did Plato’s dialogues and Academy establish a changing philosophical lineage?', secondaryHallIds: ['core-questions-forum', 'justice-democratic-reason'], principalAssetId: 'platonism-academy-site'}),
