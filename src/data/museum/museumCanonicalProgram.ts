  ...
  },
  {
    ...
    rooms: [
      ...
      {id: 'buddhist-madhyamaka', title: 'Madhyamaka: emptiness and dependence', recordCapacity: 2, exhibits: [
        exhibit({id: 'nagarjuna', entityKind: 'philosopher', entityId: 'nagarjuna', displayName: 'Nāgārjuna and the Madhyamaka Tradition', tier: 'anchor-exhibit', question: 'Nāgārjuna examines what follows when phenomena arise dependently and therefore lack self-established essence. Explore how Madhyamaka arguments use emptiness without turning it into nihilism, and why biography, authorship, translation, and later reception require caution.', secondaryHallIds: ['core-questions-forum'], principalAssetId: 'nagarjuna-sichuan-thangka'}),
      ]},
  ...
  },
  {
    ...
    rooms: [
      {id: 'latin-transmission-carolingian', title: 'Late-antique transmission and Carolingian reception', recordCapacity: 3, exhibits: [
        exhibit({id: 'boethius', entityKind: 'philosopher', entityId: 'boethius', displayName: 'Boethius: Logic, Fortune, and a Double Transmission', tier: 'standard-individual-exhibit', question: 'Boethius joined Latin logical teaching to a prison dialogue on fortune, happiness, providence, and freedom. Explore how his unfinished translation project, contested final years, and centuries of copying shaped two related but distinct philosophical inheritances.', secondaryHallIds: ['late-antiquity-inheritance'], principalAssetId: 'scholastic-boethius-miniature'}),
  ...
  },
  {
    ...
    rooms: [
      ...
      {id: 'hell-skeptical-lineages', title: 'Academic and Pyrrhonian skeptical lineages', recordCapacity: 6, exhibits: [
        ...
        exhibit({id: 'sextus-empiricus', entityKind: 'philosopher', entityId: 'sextus-empiricus', displayName: 'Sextus Empiricus: Pyrrhonian Practice Preserved', tier: 'standard-individual-exhibit', question: 'Sextus Empiricus preserves Pyrrhonian practices of opposing arguments, suspending judgment, and continuing inquiry without declaring truth impossible. Explore how his writings challenge theoretical certainty while relying on language, inference, memory, and ordinary life.', secondaryHallIds: [], principalAssetId: 'skepticism-sextus-riedel'}),
      ]},
    ],
  },
  {
