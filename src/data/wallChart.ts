...
export const wallSchools:WallSchool[]=[
  ...
  {id:'german-idealism',name:'German Idealism',startYear:1781,endYear:1850,row:6,color:'#b288d9',summary:'Kant’s critical turn becomes the source for post-Kantian systems of mind, reason, freedom, nature, and history.',branchId:'german-idealism',philosopherIds:['kant','fichte','schelling','hegel']},
  {id:'utilitarianism',name:'Utilitarianism',startYear:1789,endYear:2026,row:8,color:'#8bd17c',summary:'Bentham’s utility principle and Mill’s later revision make consequences central to ethics and policy.',branchId:'utilitarianism',philosopherIds:['bentham','mill']},
  {id:'pragmatism',name:'Pragmatism',startYear:1878,endYear:2026,row:10,color:'#d3a65c',summary:'Peirce initiates the pragmatic maxim; James and Dewey develop pragmatism as a theory of truth, inquiry, and practice.',branchId:'pragmatism',philosopherIds:['peirce','william-james','dewey']},
  ...
  {id:'existentialism',name:'Existentialism',startYear:1843,endYear:2026,row:3,color:'#e8798e',summary:'Precursors and associated figures make freedom, anxiety, responsibility, absurdity, and meaning central.',branchId:'existentialism',philosopherIds:['kierkegaard','nietzsche','sartre','beauvoir','camus']},
  {id:'analytic',name:'Analytic philosophy',startYear:1879,endYear:2026,row:6,color:'#77aadd',summary:'Frege’s logic, Russell and Moore’s analysis, and Wittgenstein’s language work help define a broad modern tradition.',branchId:'analytic-philosophy',philosopherIds:['frege','russell','g-e-moore','wittgenstein','carnap','quine','anscombe']},
...
export const wallWorks:WallWork[]=[
  ...
  {id:'principles-morals-legislation',title:'Principles of Morals and Legislation',year:1789,authorId:'bentham',schoolId:'utilitarianism',branchIds:['utilitarianism','political-philosophy'],summary:'Bentham formulates utility as a standard for ethics, law, punishment, and reform.'},
  {id:'on-liberty',title:'On Liberty',year:1859,authorId:'mill',schoolId:'utilitarianism',branchIds:['utilitarianism','political-philosophy'],summary:'Mill revises the utilitarian inheritance through liberty, individuality, and harm.'},
  {id:'genealogy',title:'On the Genealogy of Morality',year:1887,authorId:'nietzsche',schoolId:'existentialism',branchIds:['ethics','continental-philosophy'],summary:'Moral values are investigated as historical constructions and later existential inheritances.'},
