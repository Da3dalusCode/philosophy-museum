...
check(philosophers.includes("patanjali:{lifespan:'fl. uncertain")&&philosophers.includes("not through inferred birth and death years"),'Patanjali must not display as a literal 400-year lifespan.');
...
check(philosophers.includes("mahavira:{dateDisplay:'traditional 599–527 BCE; historical chronology disputed'")&&philosophers.includes("branchId:'jainism',status:'canonical'")&&philosophers.includes("not a clean modern founder claim"),'Mahavira must show disputed traditional chronology and Jain canonical status without a clean founder claim.');
check(philosophers.includes("shankara:{dateDisplay:'traditionally 788–820 CE; probably early 8th century'")&&philosophers.includes("branchId:'vedanta',status:'commentator'"),'Shankara must show debated chronology and Vedanta commentator/systematizer status.');
check(philosophers.includes("ramanuja:{dateDisplay:'traditionally 1017–1137 CE'")&&philosophers.includes("alternative chronologies")&&philosophers.includes("branchId:'vedanta',status:'commentator'"),'Ramanuja must show approximate chronology and Vedanta commentator/systematizer status.');
check(philosophers.includes("madhva:{dateDisplay:'traditionally 1238–1317 CE'")&&philosophers.includes("alternative chronologies")&&philosophers.includes("branchId:'vedanta',status:'commentator'"),'Madhva must be represented as a Vedanta commentator/systematizer.');
check(philosophers.includes("dignaga:{dateDisplay:'c. 480–540 CE; conventional and uncertain'")&&philosophers.includes("branchId:'buddhist-epistemology',status:'founder'"),'Dignaga must show approximate chronology and Buddhist Epistemology founder/systematizer status.');
check(philosophers.includes("dharmakirti:{dateDisplay:'c. 6th–7th century CE; chronology disputed'")&&philosophers.includes("branchId:'buddhist-epistemology',status:'school-systematizer'"),'Dharmakirti must show approximate/debated chronology and post-Dignaga Buddhist Epistemology status.');
