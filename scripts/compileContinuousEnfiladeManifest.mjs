...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 12);
  assert.equal(candidate.counts.plannedWalkableHallCount, 14);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 14);
  ...
  assert.equal(candidate.counts.curatedOpen, 12);
  assert.equal(candidate.counts.plannedWalkable, 14);
