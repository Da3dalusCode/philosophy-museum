...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 18);
  assert.equal(candidate.counts.plannedWalkableHallCount, 8);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 8);
  ...
  assert.equal(candidate.counts.curatedOpen, 18);
  assert.equal(candidate.counts.plannedWalkable, 8);
