...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 24);
  assert.equal(candidate.counts.plannedWalkableHallCount, 2);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 2);
  ...
  assert.equal(candidate.counts.curatedOpen, 24);
  assert.equal(candidate.counts.plannedWalkable, 2);
