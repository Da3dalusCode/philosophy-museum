...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 22);
  assert.equal(candidate.counts.plannedWalkableHallCount, 4);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 4);
  ...
  assert.equal(candidate.counts.curatedOpen, 22);
  assert.equal(candidate.counts.plannedWalkable, 4);
