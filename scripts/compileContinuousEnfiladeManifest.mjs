...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 14);
  assert.equal(candidate.counts.plannedWalkableHallCount, 12);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 12);
  ...
  assert.equal(candidate.counts.curatedOpen, 14);
  assert.equal(candidate.counts.plannedWalkable, 12);
