...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 26);
  assert.equal(candidate.counts.plannedWalkableHallCount, 0);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 0);
  ...
  assert.equal(candidate.counts.curatedOpen, 26);
  assert.equal(candidate.counts.plannedWalkable, 0);
