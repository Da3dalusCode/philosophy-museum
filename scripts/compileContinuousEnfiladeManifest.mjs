...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 25);
  assert.equal(candidate.counts.plannedWalkableHallCount, 1);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 1);
  ...
  assert.equal(candidate.counts.curatedOpen, 25);
  assert.equal(candidate.counts.plannedWalkable, 1);
