...
const validateManifest = (candidate) => {
  ...
  assert.equal(candidate.counts.curatedOpenHallCount, 20);
  assert.equal(candidate.counts.plannedWalkableHallCount, 6);
  ...
  assert.equal(candidate.counts.plannedStatusSignCount, 6);
  ...
  assert.equal(candidate.counts.curatedOpen, 20);
  assert.equal(candidate.counts.plannedWalkable, 6);
