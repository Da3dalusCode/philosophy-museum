...
assert.equal(philosopherIds.length, 147, 'The approved Atlas must contain exactly 147 philosopher records.');
...
console.log('\nCoverage contract passed: 147 philosophers and 45 branches, including Dostoevsky, Kantianism, Marxism, Marsilio Ficino, Galileo Galilei, Prodicus, Hippias of Elis, and Jiddu Krishnamurti, are covered exactly once.');
