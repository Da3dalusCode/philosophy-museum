...
assert.equal(philosopherIds.length, 142, 'The approved Atlas must contain exactly 142 philosopher records.');
...
console.log('\nCoverage contract passed: 142 philosophers and 43 branches, including Jiddu Krishnamurti, are covered exactly once.');
