...
The durable reviewed-exhibit contract is defined in the [Museum exhibit-wall standard](../museum-masterplan/exhibit-wall-standard.md). A reviewed primary exhibit is predominantly single-column and object-led; uses a roughly 32–35-word direct wall invitation; provides object caption, provenance, and interpretation; presents 250–268 words in three untitled prose paragraphs; normally uses five compact orientation entries; and links to the full sourced article. A sixth orientation entry requires a recorded subject-specific reason. Article review and exhibit review remain separate locked states, and presentation conformance never substitutes for claim review or factual reconciliation.
