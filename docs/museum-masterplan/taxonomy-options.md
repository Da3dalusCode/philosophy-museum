...
| Connected Medieval & Post-Classical Intellectual Worlds | Arabic & Islamic Philosophical Worlds; Jewish Philosophy in Arabic-Speaking & Mediterranean Worlds; Latin Christian & Scholastic Traditions | 11 | 33 |
| Early Modern Europe & Enlightenments | Renaissance, Political Order, and New Science; Rationalism: Mind, Nature, and System; Empiricism, Science, and Political Order; Enlightenment, Revolution, and Kant’s Critical Turn | 14 | 23 |
...
Every record has exactly one primary wing, hall, room, and presentation tier. A secondary association is a route back to that primary exhibit: it can support a comparison panel, map link, study-wall reference, or interpretive callback, but it does not create a duplicate primary exhibit or make a disputed membership silently certain.

This makes Aristotle ancient in his primary placement while allowing major appearances in logic, ethics, science, political thought, and Islamic, Jewish, and Latin reception. Buddhist epistemology remains within Buddhist intellectual history while also appearing through Knowledge and Logic lenses. Islamic philosophy has its own intellectual-world hall rather than becoming a preface to Latin scholasticism. The forum supplies conceptual access without stripping these records of historical setting.
...
- Its 69-slot reserve is the largest of the three options, including named rooms for transmission, regional continuity, and currently missing contexts.
- The complete primary assignments guide implementation with approved person-level adjudications including Beauvoir’s Feminist Philosophies primary, Krishnamurti’s independent Mind & Self placement, and Prodicus and Hippias in the Gallery 01 Sophists room, while preserving exact-once coverage of all 191 records; secondary route candidates still require typed room-level interpretation before they go live.

### Weaknesses and risks

- Ten wings and 26 halls demand strong orientation, maps, landmarks, and short return routes.
- The word “worlds” can falsely imply sealed civilizations unless thresholds visibly show translation, migration, controversy, and mutual reception.
- A single physical primary home can frustrate visitors who expect Kant, Beauvoir, Aristotle, or Foucault in a different thematic hall; secondary appearances must therefore be substantial and easy to follow.
- The larger reserve makes this the most generous—and potentially most expensive—program envelope.
...
Expansion can happen in three ways without changing the classification contract: fill a reserved record slot; activate a named reserve/context room; or add a hall at a wing's reserved connection point. A new tradition that cannot be presented responsibly in an existing setting should receive a new cultural-historical hall or wing rather than being forced into a generic “global” room. The 69-slot reserve is uneven by design: it protects identified gaps, but full halls still trigger local expansion instead of demotion of current records.
...
Each parenthesis gives **rooms / record capacity** for that working hall.

| Era wing | Hall roster | Wing total |
| --- | --- | ---: |
| Beginnings | Orientation: Oral, Textual, and Attributed Beginnings (3 / 7); Early South Asian, Jain, and Brahmanical Questions (4 / 10); Warring States Chinese Debates (4 / 9); Archaic Mediterranean Nature and Being (3 / 8) | **4 halls / 14 rooms / 34** |
| Classical and Late Antique | Classical Athens and Its Institutions (4 / 10); Hellenistic and Roman Ways of Life (4 / 10); Classical Indian and Buddhist Debate (3 / 8); Late-Antique Systems and Asian Transmissions (3 / 7) | **4 halls / 14 rooms / 35** |
| Medieval and Scholastic Worlds | Translation-Era Arabic and Islamic Philosophy (4 / 10); Jewish Philosophy in Arabic-Speaking and Mediterranean Worlds (3 / 6); Latin Christian and University Traditions (4 / 9); South Asian Systems and Debates (4 / 9); East Asian Buddhist and Confucian Renewals (3 / 8) | **5 halls / 18 rooms / 42** |
| Early Modern and Enlightenment | Renaissance, Statecraft, and New Science (3 / 7); Rationalism and Empiricism (4 / 10); Enlightenments and Revolution (4 / 10); Qing, Edo, Safavid, and Colonial Encounters (3 / 8) | **4 halls / 14 rooms / 35** |
| Nineteenth Century | German Idealism and Romantic Afterlives (4 / 10); Utility, Liberty, Capital, Faith, and Value (4 / 10); Empire, Reform, and Global Modernities (3 / 7) | **3 halls / 11 rooms / 27** |
| Twentieth Century to Present | Pragmatist and Analytic Turns (4 / 13); Phenomenology and Existentialism (4 / 13); Critical Theory, Genealogy, and Deconstruction (3 / 10); Feminist, Race, and Liberation Thought (3 / 10); Contemporary Questions Forum (3 / 9) | **5 halls / 17 rooms / 55** |
| **Total** | **25 halls** | **88 rooms / 228 capacity** |

The room types within each hall would recur as regional orientation, principal debates, key figures/works, institutions and transmission, and later reception. “Braid point” is an interpretive zone, not permission to collapse unlike traditions into a single school.

### Treatment of overlap

Primary placement follows the period of formation or decisive contribution. Long-lived schools reappear through secondary continuation panels and visible strands rather than repeated primary exhibits. Cross-period figures become thresholds: Kant closes the Enlightenment route and points toward German Idealism; Mulla Sadra appears in the early-modern Safavid strand rather than being misdated as simply “medieval”; Aristotle's ancient primary home feeds later Arabic, Jewish, and Latin reception routes.
...
A dated main promenade supplies orientation, but no regional strand should become a cul-de-sac. Each era needs at least two cross-connections, a visible “you are simultaneous with” sightline, and a return route that does not require walking the full chronology. Visitors need filters for era, region/tradition, and question because architecture alone cannot display all three equally.
...
| Question/method wing | Hall roster | Wing total |
| --- | --- | ---: |
| Reality and Being | Metaphysics and Ontology (4 / 11); Nature, Cosmology, and Divinity (3 / 8); Change, Dependence, Substance, and Emptiness (3 / 9) | **3 halls / 10 rooms / 28** |
| Knowledge and Method | Knowledge, Doubt, and Skepticism (4 / 11); Reason, Experience, and Scientific Inquiry (4 / 11); Proof, Debate, Pramāṇa, and Testimony (3 / 9) | **3 halls / 11 rooms / 31** |
| Mind, Logic, and Language | Mind, Self, and Consciousness (4 / 11); Logic, Inference, and Formal Traditions (3 / 8); Language, Signs, and Interpretation (4 / 11); Embodiment, Action, and Intention (3 / 8) | **4 halls / 14 rooms / 38** |
| Ethics and Ways of Life | Character, Flourishing, and Cultivation (4 / 11); Duty, Consequence, Care, and Moral Attention (3 / 9); Liberation, Suffering, and Transformative Practice (3 / 8) | **3 halls / 10 rooms / 28** |
| Power, Justice, and Society | Authority, Statecraft, and Civic Action (4 / 12); Justice, Rights, and Democracy (4 / 12); Labor, Capital, Institutions, and Power (4 / 11); Feminism, Race, Colonialism, and Liberation (3 / 9) | **4 halls / 15 rooms / 44** |
| Art, Interpretation, and Value | Beauty, Art, and Aesthetic Judgment (3 / 8); Hermeneutics, Genealogy, Meaning, and Value (4 / 11) | **2 halls / 7 rooms / 19** |
| Historical Context Houses | Mediterranean Antiquity (3 / 8); South Asian Intellectual Worlds (3 / 8); Buddhist Traditions Across Asia (3 / 8); Chinese & East Asian Intellectual Worlds (3 / 8); Connected Medieval Worlds (4 / 11); Early Modern to Contemporary Context (3 / 9) | **6 halls / 19 rooms / 52** |
| **Total** | **25 halls** | **86 rooms / 240 capacity** |

Thematic rooms would be organized as contested answers rather than as a procession of “great thinkers.” Each exhibit would carry a prominent context marker and a direct route to its Historical Context House.

### Treatment of overlap

Primary placement follows the record's most consequential question or method; historical context becomes a required secondary association. A philosopher active across several questions receives one full primary installation and compact cross-references elsewhere. Context Houses hold timelines, institutions, translation histories, disputed memberships, and internal genealogies, not merely introductory labels.
...
- It is the most anachronism-prone option. Modern field names can be projected backward onto thinkers who understood their work differently.
- Cultural and religious practices can be reduced to detachable “answers” in a comparative grid.
- Context Houses may become annexes that visitors skip, recreating a supposedly universal thematic center and peripheral histories.
- Multi-field figures such as Kant, Aristotle, Wittgenstein, Foucault, Beauvoir, and Buddhist pramāṇa thinkers make primary placement feel especially arbitrary.
- Six context houses are not enough for equal depth without careful subdivision; the Connected Medieval house is particularly compressed.

### Navigation implications

The plan behaves as a network rather than a sequence. A central index should offer a question, tradition, period, or thinker as four equal entry modes. Every thematic exhibit needs a visible “return to context” route, and every Context House needs outward routes to the questions it informs. This enables short targeted visits but provides a weaker default narrative for a visitor who simply walks forward.
