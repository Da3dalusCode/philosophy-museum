...
The program establishes what the Museum houses and the intellectual rules the production Continuous Enfilade must preserve. The complete building provides all 26 walkable gallery shells and 105 named rooms; Galleries 01–24 and Gallery 26 are curated/open, while Gallery 25 remains planned/walkable without invented content or fast travel. These runtime promotions do not change the locked program’s 189 assigned records, 260 capacity, or 71-slot whole-program reserve.
