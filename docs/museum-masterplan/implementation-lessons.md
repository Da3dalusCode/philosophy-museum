...
- Galleries 20 and 21 establish the preferred result rather than merely meeting the ceiling: all 42 images are standalone, directly relevant visual objects, with zero text-dominant pages or isolated-book views and at least four non-textual visual-character groups in each gallery.
